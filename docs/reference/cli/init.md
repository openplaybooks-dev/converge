...
Scaffold a new project. Creates `.converge/project.yaml` with AI provider config and a `.gitignore`. The interactive wizard can choose a provider template, enabled agents, and the default agent.
