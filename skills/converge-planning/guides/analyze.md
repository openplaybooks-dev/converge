...
Combine all findings into `.converge/analysis.md`:
...
- `.converge/analysis.md` exists and is non-empty
...
- **Already analyzed recently:** Read existing `.converge/analysis.md`, update only if stale
