...
**Input:** `.converge/analysis.md` (if exists — from Phase 1)
**Output:** `.converge/requirements.md`
...
After all questions, write `.converge/requirements.md`:
...
- `.converge/requirements.md` exists and covers all 7 areas
