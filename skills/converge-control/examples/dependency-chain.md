...
- Converge resolves across epic boundaries
...
- Converge figures it out from `dependencies:`
...
grep -r "dependencies" .converge/epics/*/tasks/*/TASK.md
...
converge reset {upstream-task-id}
converge run --step {upstream-task-id}
```
...
grep "dependencies" .converge/epics/{epic}/tasks/{task}/TASK.md
...
5. Visualize with `converge tree` to verify
