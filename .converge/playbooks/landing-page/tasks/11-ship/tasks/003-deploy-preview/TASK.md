---
id: 003-deploy-preview
title: Deploy to Cloudflare Pages preview environment
dependencies: [002-cloudflare-headers]
inputs:
...
checks:
  - id: preview-deployed
    cmd: "test -f apps/landing/.preview-deploy-url && grep -qE 'pages\\.dev|workers\\.dev' apps/landing/.preview-deploy-url"
