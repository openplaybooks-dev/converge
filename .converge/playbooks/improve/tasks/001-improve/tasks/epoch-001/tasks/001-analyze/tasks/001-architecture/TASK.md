---
id: 001-architecture
title: Architecture analysis — epoch 1
checks:
  - id: report-written
    description: Architecture analysis report exists
    cmd: test -f /Users/minh/Documents/converge/.converge/artifacts/improve/epochs/001/architecture/report.md
vars:
  taskId: 001-architecture
  epoch: 1
...
Write `/Users/minh/Documents/converge/.converge/artifacts/improve/epochs/001/architecture/report.md`:
