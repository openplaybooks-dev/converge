...
checks:
  ...
  - id: tests-fail
    cmd: "! pnpm --filter @openplaybooks/converge-core test -- run-results-types 2>/dev/null"
...
Run `pnpm --filter @openplaybooks/converge-core test -- run-results-types`. Expected RED —
