---
id: 003-verify
title: Verify implementation — PR5 — Move + split cli/autonomous-run.ts → orchestrator/autonomous/
checks:
  - id: typecheck
...
# Verify implementation — PR5 — Move + split cli/autonomous-run.ts → orchestrator/autonomous/
