---
id: 002-todos
title: Execute todos — PR5 — Move + split cli/autonomous-run.ts → orchestrator/autonomous/
wbs:
  type: nodejs
...
# Execute implementation — PR5 — Move + split cli/autonomous-run.ts → orchestrator/autonomous/
