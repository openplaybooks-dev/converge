---
id: 001-analyze
title: "Analyze — PR13 — Extract @converge/cli workspace package"
checks:
  - id: plan-written
    description: Analysis plan exists
    cmd: "test -f D:/converge/.converge/artifacts/split-cli/016-extract-cli-pkg/analyze/plan.md"
vars:
  taskId: 001-analyze
...
# Analyze — PR13 — Extract @converge/cli workspace package
...
Write `D:/converge/.converge/artifacts/split-cli/016-extract-cli-pkg/analyze/plan.md`:

```markdown
# PR13 — Extract @converge/cli workspace package — Analysis
