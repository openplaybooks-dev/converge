---
id: 003-verify
title: Verify implementation — PR14 — Final layering gate (ESLint + madge + programmatic smoke)
checks:
  - id: typecheck
...
# Verify implementation — PR14 — Final layering gate (ESLint + madge + programmatic smoke)
