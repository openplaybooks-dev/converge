---
id: 001-analyze
title: Analyze — PR14 — Final layering gate (ESLint + madge + programmatic smoke)
checks:
  - id: plan-written
    description: Analysis plan exists
    cmd: "test -f D:/converge/.converge/artifacts/split-cli/017-layering-audit/analyze/plan.md"
vars:
  taskId: 001-analyze
...
# Analyze — PR14 — Final layering gate (ESLint + madge + programmatic smoke)
...
Write `D:/converge/.converge/artifacts/split-cli/017-layering-audit/analyze/plan.md`:

```markdown
# PR14 — Final layering gate (ESLint + madge + programmatic smoke) — Analysis
