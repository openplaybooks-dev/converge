---
id: 003-verify
title: "Verify implementation — PR3b — Extract @converge/navigator workspace package (zero-dep)"
checks:
  - id: typecheck
...
# Verify implementation — PR3b — Extract @converge/navigator workspace package (zero-dep)
