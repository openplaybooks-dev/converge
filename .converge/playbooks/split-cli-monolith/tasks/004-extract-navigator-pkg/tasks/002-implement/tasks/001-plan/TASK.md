---
id: 001-plan
title: "Plan implementation — PR3b — Extract @converge/navigator workspace package (zero-dep)"
checks:
  - id: impl-plan-written
    description: Implementation plan exists
    cmd: "test -f D:/converge/.converge/artifacts/split-cli/004-extract-navigator-pkg/implement/plan.md"
vars:
  taskId: 001-plan
...
# Plan implementation — PR3b — Extract @converge/navigator workspace package (zero-dep)

Read the analysis and produce a concrete, file-level implementation plan.

## Steps

1. Read `D:/converge/.converge/artifacts/split-cli/004-extract-navigator-pkg/analyze/plan.md`.
...
Write `D:/converge/.converge/artifacts/split-cli/004-extract-navigator-pkg/implement/plan.md`:

```markdown
# PR3b — Extract @converge/navigator workspace package (zero-dep) — Implementation Plan
