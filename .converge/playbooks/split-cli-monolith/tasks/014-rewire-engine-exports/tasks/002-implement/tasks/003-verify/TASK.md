---
id: 003-verify
title: Verify implementation — PR11c — Re-wire engine exports + move autonomousRun out of core
checks:
  - id: typecheck
...
# Verify implementation — PR11c — Re-wire engine exports + move autonomousRun out of core
