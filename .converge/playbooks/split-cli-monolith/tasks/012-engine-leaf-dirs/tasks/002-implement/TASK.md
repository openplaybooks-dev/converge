---
id: 002-implement
title: "Implement — PR11a — Extract @converge/engine: leaf dirs (no engine-to-engine fanout)"
wbs:
  type: nodejs
...
# Implement — PR11a — Extract @converge/engine: leaf dirs (no engine-to-engine fanout)
