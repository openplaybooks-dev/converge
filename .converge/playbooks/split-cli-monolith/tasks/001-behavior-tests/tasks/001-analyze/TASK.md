---
id: 001-analyze
title: Analyze — PR1 — Behavior-locking tests (safety net)
checks:
  - id: plan-written
    description: Analysis plan exists
    cmd: "test -f D:/converge/.converge/artifacts/split-cli/001-behavior-tests/analyze/plan.md"
vars:
  taskId: 001-analyze
...
# Analyze — PR1 — Behavior-locking tests (safety net)
...
Write `D:/converge/.converge/artifacts/split-cli/001-behavior-tests/analyze/plan.md`:

```markdown
# PR1 — Behavior-locking tests (safety net) — Analysis
