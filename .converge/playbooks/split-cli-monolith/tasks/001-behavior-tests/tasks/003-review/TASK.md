---
id: 003-review
title: Review — PR1 — Behavior-locking tests (safety net)
checks:
  - id: review-approved
    description: Code review passed
    cmd: "grep -q 'APPROVED' D:/converge/.converge/artifacts/split-cli/001-behavior-tests/review/report.md"
vars:
  taskId: 003-review
...
# Code review — PR1 — Behavior-locking tests (safety net)

Review the diff against the PR spec and acceptance criteria.

## Inputs

- **PR summary:** Tests against current file paths so every subsequent move/split is regression-proof. Includes a recorded-trace test of converge() to lock navigator JIT semantics.
- **Full spec:**
...
- Implementation plan: `D:/converge/.converge/artifacts/split-cli/001-behavior-tests/implement/plan.md`
...
Write `D:/converge/.converge/artifacts/split-cli/001-behavior-tests/review/report.md`:
