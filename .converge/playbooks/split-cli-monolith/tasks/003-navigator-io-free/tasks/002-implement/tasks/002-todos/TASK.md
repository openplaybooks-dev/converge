---
id: 002-todos
title: "Execute todos — PR3a — Make navigator I/O-free (parameterize + inject, still in-core)"
wbs:
  type: nodejs
...
# Execute implementation — PR3a — Make navigator I/O-free (parameterize + inject, still in-core)
