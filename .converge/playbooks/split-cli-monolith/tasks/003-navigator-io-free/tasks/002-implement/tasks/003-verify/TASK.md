---
id: 003-verify
title: "Verify implementation — PR3a — Make navigator I/O-free (parameterize + inject, still in-core)"
checks:
  - id: typecheck
...
# Verify implementation — PR3a — Make navigator I/O-free (parameterize + inject, still in-core)
