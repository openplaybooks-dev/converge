...
**Output**:
```
Command failed: test -f apps/landing/src/pages/index.astro && grep -qE "import\s+SocialProof\s+from" apps/landing/src/pages/index.astro
```
...
**Output**:
```
Command failed: test -f apps/landing/src/pages/index.astro && grep -qE '<SocialProof\b' apps/landing/src/pages/index.astro
```
