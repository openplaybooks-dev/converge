...
**Output**:
```
Command failed: test -f apps/landing/src/pages/index.astro && grep -qE "import\s+InteractiveComparison\s+from" apps/landing/src/pages/index.astro
```
...
**Output**:
```
Command failed: test -f apps/landing/src/pages/index.astro && grep -qE '<InteractiveComparison\b' apps/landing/src/pages/index.astro
```
