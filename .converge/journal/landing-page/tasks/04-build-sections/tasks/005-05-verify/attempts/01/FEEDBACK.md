...
**Output**:
```
Command failed: test -f apps/landing/dist/index.html && grep -qE 'id="comparison"' apps/landing/dist/index.html
```
...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/comparison/PASSED
```
