---
id: 002-05-verify
title: "Verify: Trusted by builders"
description: Build the site and confirm the Trusted by builders section renders + passes section-specific assertions.
dependencies:
  - 002-04-integrate
tags:
  - verify
...
checks:
  ...
  - id: section-id-rendered
    description: "<section id=social-proof> is in the rendered HTML"
    cmd: "test -f apps/landing/dist/client/index.html && grep -qE 'id=\"social-proof\"' apps/landing/dist/client/index.html"
  - id: passed-marker
    description: PASSED marker file written (signals next section can start)
    cmd: test -f apps/landing/.content/sections/social-proof/PASSED
vars:
  prefix: 002
