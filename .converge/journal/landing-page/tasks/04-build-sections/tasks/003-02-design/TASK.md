---
id: 003-02-design
title: "Design: Define how vs. define done"
...
checks:
  - id: design-md-exists
    ...
    cmd: test -f apps/landing/.content/sections/problem-solution/DESIGN.md
  - id: design-has-content
    description: "DESIGN.md has >=30 lines"
    cmd: "test -f apps/landing/.content/sections/problem-solution/DESIGN.md && test $(wc -l < apps/landing/.content/sections/problem-solution/DESIGN.md) -ge 30"
  - id: design-lists-imports
    description: DESIGN.md lists which UI/layout primitives to import
    cmd: "test -f apps/landing/.content/sections/problem-solution/DESIGN.md && grep -qE 'import|components/ui|components/layout' apps/landing/.content/sections/problem-solution/DESIGN.md"
vars:
  prefix: 003
