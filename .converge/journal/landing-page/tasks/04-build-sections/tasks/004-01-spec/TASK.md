---
id: 004-01-spec
title: "Spec: Six differentiators"
description: "Write SPEC.md for the Six differentiators section: intent, props, content sources, slots, acceptance criteria."
tags:
  - spec
...
checks:
  - id: spec-md-exists
    description: apps/landing/.content/sections/feature-grid/SPEC.md exists
    cmd: test -f apps/landing/.content/sections/feature-grid/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >=40 lines (substantive)"
    cmd: "test -f apps/landing/.content/sections/feature-grid/SPEC.md && test $(wc -l < apps/landing/.content/sections/feature-grid/SPEC.md) -ge 40"
  - id: spec-references-brand
    description: SPEC references brand spec or tokens
    cmd: "test -f apps/landing/.content/sections/feature-grid/SPEC.md && grep -qE '(palette|tagline|brand|tokens)' apps/landing/.content/sections/feature-grid/SPEC.md"
plan:
vars:
  prefix: 004
