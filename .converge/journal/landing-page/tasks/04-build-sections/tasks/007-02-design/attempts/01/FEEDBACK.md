...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/faq/DESIGN.md
```
...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/faq/DESIGN.md && test $(wc -l < apps/landing/.content/sections/faq/DESIGN.md) -ge 30
```
...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/faq/DESIGN.md && grep -qE 'import|components/ui|components/layout' apps/landing/.content/sections/faq/DESIGN.md
```
