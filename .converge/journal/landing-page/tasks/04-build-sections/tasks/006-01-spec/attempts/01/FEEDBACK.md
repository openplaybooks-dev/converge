...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/quickstart/SPEC.md
```
...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/quickstart/SPEC.md && test $(wc -l < apps/landing/.content/sections/quickstart/SPEC.md) -ge 40
```
...
**Output**:
```
Command failed: test -f apps/landing/.content/sections/quickstart/SPEC.md && grep -qE '(palette|tagline|brand|tokens)' apps/landing/.content/sections/quickstart/SPEC.md
```
