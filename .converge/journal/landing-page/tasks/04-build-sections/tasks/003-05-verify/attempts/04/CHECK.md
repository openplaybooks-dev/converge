# Checks: 04-build-sections/003-05-verify
...
**Command**: `test -f apps/landing/dist/client/index.html && grep -qE 'id="problem-solution"' apps/landing/dist/client/index.html`

## passed-marker
**Description**: PASSED marker file written (signals next section can start)
**Command**: `test -f apps/landing/.content/sections/problem-solution/PASSED`