---
id: 003-e2e-verify
title: End-to-end verification against this repo
dependencies:
  - 002-cli-studio-command
outputs:
  - .converge/studio-state/e2e-verify.json
checks:
  - id: report-written
    ...
    cmd: "test -f .converge/studio-state/e2e-verify.json && node -e \"const r=JSON.parse(require('fs').readFileSync('.converge/studio-state/e2e-verify.json','utf8'));process.exit(Array.isArray(r.scenarios)&&r.scenarios.length>0?0:1)\""
---
