---
id: 006-live-session-view
title: Live session view (gantt + journal stream + task panel)
dependencies:
  - 001-prune-mc-pages
  - 007-view-modes
outputs:
  - packages/converge-studio/src/app/runs/[playbook]/[sessionId]/page.tsx
checks:
  - id: page-exists
    description: Live session view exists
    cmd: "test -f 'packages/converge-studio/src/app/runs/[playbook]/[sessionId]/page.tsx'"
  - id: typecheck
