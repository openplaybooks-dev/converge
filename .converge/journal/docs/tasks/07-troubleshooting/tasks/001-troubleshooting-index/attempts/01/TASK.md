# Task: 07-troubleshooting/001-troubleshooting-index
...
A numbered list of every symptom in `docs/_troubleshooting.json`, in
...
- `docs/_troubleshooting.json` — the canonical symptom list.
