...
describe("TypeScriptBuilder", () => {
  describe("fn", () => {
    ...
    it("emits an exported function", () => {
      const b = new TypeScriptBuilder().fn(
        "greet",
        "",
        (b) => {
          b.line("return null;");
  ...
  describe("arrow", () => {
    ...
    it("emits an exported async arrow with type", () => {
      const b = new TypeScriptBuilder().arrow(
        "handler",
        "req: Request",
        (b) => {
          b.line("return null;");
  ...
  describe("iface", () => {
    ...
    it("emits a non-exported interface", () => {
      const b = new TypeScriptBuilder().iface(
        "Internal",
        (b) => {
          b.line("x: number;");
        },
  ...
  describe("enumDecl", () => {
    ...
    it("emits a non-exported enum", () => {
      const b = new TypeScriptBuilder().enumDecl(
        "Dir",
        (b) => {
          b.line("Up,");
        },
  ...
  describe("constObject", () => {
    ...
    it("emits with type annotation and export", () => {
      const b = new TypeScriptBuilder().constObject(
        "meta",
        (b) => {
          b.line("title: 'App',");
        },
  ...
  describe("constArray", () => {
    ...
    it("emits with type annotation and export", () => {
      const b = new TypeScriptBuilder().constArray(
        "routes",
        (b) => {
          b.line("'/home',");
        },
  ...
  describe("constCall", () => {
    ...
    it("emits an exported constCall", () => {
      const b = new TypeScriptBuilder().constCall(
        "font",
        "createFont",
        (b) => {
          b.line("weight: '400',");
