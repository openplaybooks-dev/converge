...
describe("Seed Path Resolution Integration", () => {
  const exampleProjectPath =
    "/Users/minh/Documents/converge/artifacts/claude-reactjs/example";

  describe("Real Seed Task: 002-001-page-home-dashboard", () => {
  ...
  describe("Real Seed Parent: 002-generate-react-pages", () => {
    const taskPath = path.join(
      exampleProjectPath,
  ...
  describe("Real Seed Task: 003-001-asset-logo", () => {
    const taskPath = path.join(
      exampleProjectPath,
