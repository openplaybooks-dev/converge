...
function makeInput(
  ...
  return {
    ...
    rawFrontmatter: {},
    filePath: `/project/.converge/epics/01/${id}/TASK.md`,
    taskDir: `/project/.converge/epics/01/${id}`,
    projectDir: '/project',
    ...overrides,
  };
}
  ...
  describe('duplicate-task-ids', () => {
    it('flags duplicate task ids', () => {
      const tasks = [
        ...
        makeInput({ id: '001-setup' }, {
          filePath: '/project/.converge/epics/02/001-setup/TASK.md',
          taskDir: '/project/.converge/epics/02/001-setup',
        }),
      ];
