  ...
  it('should NOT mark epic without active tasks with ▶ indicator', () => {
    const tree: TaskNode[] = [
      ...
      },
      {
        ...
        filePath: '.converge/epics/03-implement-app/001-implement-design-system/TASK.md',
        relPath: '.converge/epics/03-implement-app/001-implement-design-system/TASK.md',
