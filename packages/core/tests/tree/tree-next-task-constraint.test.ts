  ...
  it('should identify next child task when WBS parent is running', () => {
    ...
    const tree: TaskNode[] = [
      ...
      },
      {
        ...
        filePath: '.converge/epics/01-prepare-designs/003-generate-screens/tasks/003-002-generate-profile-screen/TASK.md',
        relPath: '.converge/epics/01-prepare-designs/003-generate-screens/tasks/003-002-generate-profile-screen/TASK.md',
