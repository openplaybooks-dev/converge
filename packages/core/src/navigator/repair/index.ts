 ...
 *
 * Skill strategies (loaded from .converge/skills/repair/ + builtin templates):
...
export { converge } from "../core/navigator.ts";
export type { ConvergeOptions, ConvergeResult } from "../core/navigator.ts";
export { NavigatorGraph } from "../core/graph.ts";
export {
  buildPreflightNodes,
  buildResponseNodes,
  ...
  buildInitialNodes,
  GOAL_CONDITIONS,
} from "../core/default-graph.ts";
export { buildActionRegistry } from "../core/actions/index.ts";
export type {
  GraphNode,
  GraphEdge,
  Graph,
