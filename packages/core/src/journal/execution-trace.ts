 ...
 *
 * Meta-Converge optimization (arxiv 2603.28052): Store full execution traces
 ...
 * format, discarding the execution traces that Meta-Converge uses for targeted
 * diagnosis.
 *
 * Output: .converge/journal/tasks/{epic}/tasks/{task}/attempts/{N}/trace.jsonl
 *
