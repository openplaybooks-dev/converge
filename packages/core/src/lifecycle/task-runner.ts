...
export async function executeTask(
  ...
  const displayPath = normalizedWipDir.split('.converge/journal/')[1] ?? normalizedWipDir;
  ...
  (global as any).__CONVERGE_CURRENT_TASK__ = { journalTaskId: ctx.journalTaskId, unitCkpt };
