...
OPTIONS
  --task=PATH               Drill into a specific task (e.g., 03-build/001-home)
  --converge                Show convergence graph for a task (requires --task)
...
EXAMPLES
  converge inspect
  converge inspect --task=03-build-screens/001-home
  converge inspect --task=03-build-screens/001-home --converge
...
OPTIONS
  ...
  --task=PATH               Verify a specific task
  --dir=PATH                Project directory (default: cwd)

EXAMPLES
  converge verify
  converge verify --fix
  converge verify --task=03-build-screens
`,
