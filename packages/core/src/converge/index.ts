export { gapWeight, totalScore, scoreByKind, scoreBySeverity, sortByWeight } from './weights.ts';
export { appendLedgerEntry, readLedger, formatTrendTable, closeOrphanedRuns } from './gap-ledger.ts';
export type { LedgerEntry } from './gap-ledger.ts';
export { backlogItemToGap, collectBacklogGaps } from './backlog-bridge.ts';
export { evaluateAndPlan, evaluateGoals, planFromGoals, writeGoalDefs } from './goal-planner.ts';
