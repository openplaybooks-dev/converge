...
The crew framework resolves paths relative to `.converge/setup/plan/`, not relative to the current file. To support true relative paths like `./prompts/analyze-page.md`, we would need to:
