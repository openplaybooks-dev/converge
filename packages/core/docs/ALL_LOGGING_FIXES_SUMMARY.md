...
│   - Iteration tracking                                   │
│   - Task selection                                       │
│   File: .converge/journal/sessions/{session}/events.jsonl│
└─────────────────────────────────────────────────────────┘
                           │
                           ▼
┌─────────────────────────────────────────────────────────┐
...
pnpm converge run --step | grep "Starting convergence" | wc -l
...
pnpm converge run --step | grep -E "📖|✍️|⚙️"
