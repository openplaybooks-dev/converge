...
```bash
$ ls -la .converge/journal/epics/02-prepare-designs/tasks/003-001-design-home-lesson-tree/attempts/wip/logs/
...
```bash
tail -f .converge/journal/epics/*/tasks/*/attempts/wip/logs/*.log | grep -E "(TOOL_USE|REASONING|RESULT)"
```
