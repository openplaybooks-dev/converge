...
export interface GlobalQueueOptions {
  /** Maximum concurrent Qwen CLI processes across all Node processes (default: 5) */
  maxConcurrent?: number;
  /** Maximum requests per minute across all Node processes (default: 60) */
  maxPerMinute?: number;
  /** Directory for cross-process state files (default: ~/.qwenfn) */
  stateDir?: string;
 ...
 * All qwenfn/compose calls share this queue unless a custom queue is provided.
 */
