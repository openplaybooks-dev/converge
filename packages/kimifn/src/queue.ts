...
export interface GlobalQueueOptions {
  /** Maximum concurrent Kimi CLI processes across all Node processes (default: 5) */
  maxConcurrent?: number;
  /** Maximum requests per minute across all Node processes (default: 60) */
  maxPerMinute?: number;
  /** Directory for cross-process state files (default: ~/.kimifn) */
  stateDir?: string;
 ...
 * All kimifn/compose calls share this queue unless a custom queue is provided.
 */
