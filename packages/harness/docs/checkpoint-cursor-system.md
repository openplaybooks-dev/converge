...
const resumePoint = await resumeFromCheckpoint(checkpoint, harnessDir);
...
cursor:
  ...
  breadcrumbs:
    - id: '01-data-analysis'
      type: epic
      filePath: '.harness/epics/01-data-analysis/epic.ts'
      depth: 0
    - id: '003-generate-all-screens'
      type: task
      filePath: '.harness/epics/01-data-analysis/003-generate-all-screens/SKILL.md'
      depth: 1
    - id: '002-screen-invoice-detail'
      type: subtask
      filePath: '.harness/epics/01-data-analysis/003-generate-all-screens/tasks/002-screen-invoice-detail/SKILL.md'
      depth: 2
  depth: 2
...
treeSnapshot:
  ...
  taskPaths:
    - '.harness/epics/01-data-analysis/001-analyze-data/SKILL.md'
    - '.harness/epics/01-data-analysis/002-generate-design-system/SKILL.md'
    - '.harness/epics/01-data-analysis/003-generate-all-screens/SKILL.md'
    - '.harness/epics/01-data-analysis/003-generate-all-screens/tasks/001-screen-dashboard/SKILL.md'
    - '.harness/epics/01-data-analysis/003-generate-all-screens/tasks/002-screen-invoice-detail/SKILL.md'
    - '.harness/epics/01-data-analysis/003-generate-all-screens/tasks/003-screen-history/SKILL.md'
...
3. **CLI Integration**: Add `harness resume` command
