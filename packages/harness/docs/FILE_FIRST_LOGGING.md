...
```typescript
// Location: .harness/journal/epics/{epicId}/tasks/{taskId}/attempts/{attempt}/events.jsonl
...
await replayConsole('.harness/journal/epics/02-prepare-designs/tasks/003-001.../attempts/01/events.jsonl');
```
