...
**Original plan**: YAML config files (`.harness/config.yml`)
...
### Integration (Week 1)
- [ ] Add CLI flag: `--v2` to `harness run`
...
### Rollout (Week 4)
- [ ] Feature flag: `HARNESS_V2=1` environment variable
