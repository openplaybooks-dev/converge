...
The harness framework uses a nested context hierarchy to manage state and scope during autonomous execution.
...
│  Harness Dir: /path/to/workspace/.harness
│
...
│    Goals: 0 goal(s)
│    Path: .harness/epics/02-ux-ui-design-screen-generation/epic.ts
│
