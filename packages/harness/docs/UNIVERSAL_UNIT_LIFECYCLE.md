...
### Project
- **Location**: `.harness/journal/project/checkpoint.json`
- **Purpose**: Top-level container tracking overall project progress
- **Children**: Epics
- **Executable**: No (aggregates epic progress only)

### Epic
- **Location**: `.harness/journal/epics/{epicId}/checkpoint.json`
- **Definition**: `.harness/epics/{epicId}/epic.ts` (uses `taskDef()`)
...
### Task
- **Location**: `.harness/journal/epics/{epicId}/tasks/{taskId}/checkpoint.json`
- **Definition**: `.harness/epics/{epicId}/{taskId}/task.ts` or `SKILL.md`
...
### Subtask
- **Location**: `.harness/journal/epics/{epicId}/tasks/{parentId}/{childId}/checkpoint.json`
- **Definition**: `.harness/epics/{epicId}/{parentId}/{childId}/SKILL.md`
...
### 1. Discovery
- Scan `.harness/epics/` for `epic.ts` and `task.ts`/`SKILL.md` files
...
```typescript
// .harness/epics/02-prepare-designs/epic.ts
...
### Task with Subtasks
```typescript
// .harness/epics/02-prepare-designs/002-generate-screen-prompts/task.ts
export default taskDef()
