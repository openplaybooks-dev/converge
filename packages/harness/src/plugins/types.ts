...
/**
 * Enhanced harness plugin for gap-driven architecture
 */
export interface HarnessPluginV2 {
...
/**
 * Legacy alias for HarnessPluginV2
 * @deprecated Use HarnessPluginV2 instead
 */
export type HarnessPlugin = HarnessPluginV2;
