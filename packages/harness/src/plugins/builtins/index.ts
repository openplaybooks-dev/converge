 ...
 *   - PLUGIN.md  — human-readable descriptor (copied to .harness/plugins/ on init)
 */
...
const builtins = new Map<string, HarnessPlugin>([
 ...
 */
export function getBuiltinPlugin(name: string): HarnessPlugin | undefined {
