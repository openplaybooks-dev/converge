 ...
 *
 * Install skills from the harness to target directories like .claude/skills
 */
...
/**
 * Get the harness package skills directory
 */
function getHarnessSkillsDir(): string {
...
/**
 * List available skills in the harness
 */
async function listAvailableSkills(): Promise<string[]> {
  const skillsDir = getHarnessSkillsDir();
...
export async function skillsListCommand(options: SkillsListOptions = {}): Promise<void> {
  console.log('📚 Available Harness Skills:\n');
...
export async function skillsInstallCommand(options: SkillsInstallOptions = {}): Promise<void> {
  ...
  console.log('📦 Installing Harness Skills\n');
