...
import { resolveHarnessConfig } from '../config/loader.js';
import { validateHarnessConfig } from '../config/validator.js';
 ...
 *
 * @param projectDir - Root directory of the harness project
...
export async function reconcile(
  ...
  // 1. Resolve harness config and scan filesystem for all tasks
