 ...
 *
 * Meta-Harness core optimization (arxiv 2603.28052): Instead of stuffing all
 ...
 *
 * The Meta-Harness proposer reads a median of 82 files per iteration but from
 ...
 *
 * We write:
 *   .harness/journal/{epic}/{task}/attempts/wip/context/
