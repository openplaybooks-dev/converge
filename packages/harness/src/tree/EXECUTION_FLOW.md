...
```typescript
const taskPath = '.harness/epics/03-implement-app/001-implement-design-system';
...
// → .harness/journal/tasks/03-implement-app/001-implement-design-system
```
...
### 4. No Confusion
- **Task definition**: `.harness/epics/03-implement-app/001-task/`
- **Task execution**: `.harness/journal/tasks/03-implement-app/001-task/`
...
### Task Structure
```
.harness/epics/03-implement-app/
...
```
.harness/journal/tasks/03-implement-app/
└── 003-generate-svg-assets/
...
// Checkpoint path:
// .harness/journal/tasks/03-implement-app/003-generate-svg-assets/task/003-001-asset-logo/checkpoint.json
```
