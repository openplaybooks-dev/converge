...
import type { TaskDefinition, LoopFn, ExecutorFn, HarnessConfig, WbsFn, PlanConfig, CheckEntry, TaskContext as CallbackContext, Check } from '../config/task-definition.ts';
...
export class Unit implements TaskDefinition {
  ...
  constructor(config: {
    ...
    this.harnessConfig = config.taskDef.harnessConfig;
