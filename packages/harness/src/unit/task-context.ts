 ...
 *   journalPath: ".harness/journal/tasks/03-implement-app/003-generate-svg-assets/tasks/003-001-asset-logo"
 *
...
export interface TaskContext {
   ...
   * Example: ".harness/journal/tasks/03-implement-app/003-generate-svg-assets/tasks/003-001-asset-logo"
 ...
 *
 * Path parsing rules:
 * - Epics are at: .harness/epics/{epicId}/{taskId}
 * - Subtasks are at: .harness/epics/{epicId}/{parentTask}/tasks/{subtaskId}
 * - Sub-subtasks are at: .harness/epics/{epicId}/{parentTask}/tasks/{subtask}/tasks/{subsubtaskId}
 *
 * Journal paths mirror epic structure EXACTLY:
 * - Task journal: .harness/journal/tasks/{epicId}/{taskId}/
 * - Subtask journal: .harness/journal/tasks/{epicId}/{parentTask}/tasks/{subtaskId}/
 ...
 *
 * Example:
 *   parent: .harness/epics/03-app/002-pages
 *   childId: "002-001-home"
 *   result: .harness/epics/03-app/002-pages/tasks/002-001-home
 *
