 ...
 *
 * The file lives at:
 *   .harness/journal/tasks/{epicId}/tasks/{taskId}/status.json
 *
 ...
 * structure so every task in .harness/epics/ has a corresponding status
 * file in .harness/journal/.
 */
/**
 * Write (or overwrite) plan.md for a task in its journal directory.
 *
 * The file lives at:
 *   .harness/journal/tasks/{epicId}/tasks/{taskId}/plan.md
 *
 ...
 *
 * The file lives at:
 *   .harness/journal/tasks/{epicId}/status.json
 */
 ...
 *
 * The file lives at:
 *   .harness/journal/tasks/{epicId}/tasks/{taskId}/todo.md
 *
 ...
 *
 * ## Outputs
 * - [x] `.harness/epics/.../003-generate-all-screens/001-screen-*.ts`
 *
 * ## Checks
