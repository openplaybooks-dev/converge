 ...
 * in the .harness/epics folder structure. This prevents orphaned journals
...
export class JournalCleanup {
  ...
  constructor(projectDir: string) {
    ...
    this.epicsDir = path.join(projectDir, '.harness', 'epics');
  }
  ...
  /**
   * Get all valid epic IDs from .harness/epics folder.
   */
