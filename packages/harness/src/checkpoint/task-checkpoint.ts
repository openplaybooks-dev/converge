 ...
 *   .harness/journal/tasks/{epicId}/{taskId}/checkpoint.json       (root task)
 *   .harness/journal/tasks/{epicId}/{parent}/tasks/{child}/checkpoint.json  (WBS subtask)
 *
 ...
 *
 * Global checkpoint (.harness/journal/.checkpoint.json) tracks which tasks
