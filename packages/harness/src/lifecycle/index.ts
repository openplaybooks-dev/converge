 ...
 * Lifecycle Module
 *
 * Before/Execute/After task lifecycle for the Harness framework.
...
export { runAutoHarnessPhase } from './auto-harness.ts';
export type { AutoHarnessResult } from './auto-harness.ts';
