/**
 * Harness V2 - Gap-Driven Framework
 *
...
/*                                                                      */
/*  1. PROJECT.md         — YAML frontmatter config (.harness/PROJECT.md) */
...
export { validateHarnessConfig } from './config/validator.ts';
...
/* ────────────────────────────────────────────────────────────────── */
/*  Harness (Phase 2 - AutoHarness Generation System)                 */
/* ────────────────────────────────────────────────────────────────── */
...
} from './harness/refiner.ts';

export {
  HarnessCache,
  createHarnessCache,
} from './harness/cache.ts';
