...
export interface StoragePaths {
  root: string; // .harness/
  project: string; // .harness/project.yaml
  epics: string; // .harness/epics/
  checkpoints: string; // .harness/checkpoints/
  gaps: string; // .harness/gaps/
  provenance: string; // .harness/provenance/
