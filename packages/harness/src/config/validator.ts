/**
 * Harness Config Validator
 *
 * Validates `HarnessConfig` objects with clear, actionable error messages.
...
/**
 * Validate a harness config object. Throws with a clear, multi-line
