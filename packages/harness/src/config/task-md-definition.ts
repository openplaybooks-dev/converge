...
import type { AutoHarnessPolicy, SkillContextStep } from './skill-definition.ts';
import {
  parseChecks,
  parseAutoHarness,
  parseDiagnosisHints,
 ...
 * .harness/goals/{NNN}-{id}/GOAL.md file on disk.
 */
...
export interface TaskMdShape {
   ...
   * Each entry becomes a GOAL.md file in .harness/goals/{NNN}-{id}/.
