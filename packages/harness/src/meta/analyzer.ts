/**
 * Meta-Analyzer: Harness Self-Optimization Loop
 *
 * Meta-Harness insight (arxiv 2603.28052): The outer loop discovers new
 ...
 *
 * Output: .harness/meta/proposals/{timestamp}-proposal.md
 *
 * Flow:
 ...
 *   4. Write proposal to .harness/meta/proposals/
 *
...
const DEFAULT_CONFIG: MetaAnalyzerConfig = {
  ...
  proposalsDir: '.harness/meta/proposals',
};
...
export class MetaAnalyzer {
  ...
  private formatProposalAsMd(proposal: ImprovementProposal): string {
    const lines: string[] = [
      `# Harness Self-Optimization Proposal`,
      ``,
