...
describe('journal structure', () => {
  ...
  describe('getJournalStructure', () => {
    it('should create root structure without epic or task', () => {
      ...
      expect(structure.root).toBe(join(projectDir, '.harness', 'journal'));
      expect(structure.project).toBe(join(projectDir, '.harness', 'journal', 'project'));
    ...
    it('should create epic-level structure', () => {
      ...
      expect(structure.epic).toBe(join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app'));
      expect(structure.task).toBeUndefined();
    });
    ...
    it('should create task-level structure for root tasks', () => {
      ...
      expect(structure.task).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app', '002-pages')
      );
    });
    ...
    it('should create proper hierarchy for nested tasks (one level)', () => {
      ...
      expect(structure.task).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app', '002-pages', 'tasks', '002-001-home')
      );
    });
  ...
  describe('getTaskAttemptDir', () => {
    it('should create attempt dir for root task', () => {
      ...
      expect(attemptDir).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app', '002-pages', 'attempts', '01')
      );
    });
    ...
    it('should handle string attempt numbers', () => {
      ...
      expect(attemptDir).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app', '002-pages', 'attempts', 'wip')
      );
    });
    ...
    it('should pad numeric attempt numbers', () => {
      ...
      expect(attemptDir).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app', '002-pages', 'attempts', '09')
      );
    });
  ...
  describe('PlaybookContext routing', () => {
    it('should route epic paths through playbook journal', () => {
      ...
      expect(structure.epic).toBe(
        join(projectDir, '.harness', 'journal', 'react-app', 'tasks', '03-implement-app')
      );
    });
    ...
    it('should route task paths through playbook journal', () => {
      ...
      expect(structure.task).toBe(
        join(projectDir, '.harness', 'journal', 'react-app', 'tasks', '03-implement-app', '002-pages')
      );
    });
    ...
    it('should route nested task paths through playbook journal', () => {
      ...
      expect(structure.task).toBe(
        join(projectDir, '.harness', 'journal', 'react-app', 'tasks', '03-implement-app', '002-pages', 'tasks', '002-001-home')
      );
    });
    ...
    it('should use "default" playbook name for default runs', () => {
      ...
      expect(structure.epic).toBe(
        join(projectDir, '.harness', 'journal', 'default', 'tasks', '03-implement-app')
      );
    });
  ...
  describe('PlaybookContext from env vars', () => {
    ...
    it('should resolve playbook context from HARNESS_PLAYBOOK env var', () => {
      process.env.HARNESS_PLAYBOOK = 'react-app';
    ...
    it('should prefer explicit context over env var', () => {
      process.env.HARNESS_PLAYBOOK = 'from-env';
    ...
    it('should route nested task paths through env-based context', () => {
      process.env.HARNESS_PLAYBOOK = 'fix-issue';

      const structure = getJournalStructure(projectDir, '03-implement-app', '002-pages/002-001-home');

      expect(structure.task).toBe(
        join(projectDir, '.harness', 'journal', 'fix-issue', 'tasks', '03-implement-app', '002-pages', 'tasks', '002-001-home')
      );
    });
  });
});
