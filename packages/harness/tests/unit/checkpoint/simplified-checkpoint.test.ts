...
describe('Simplified Checkpoint System (V3)', () => {
  describe('Checkpoint Structure', () => {
    it('should have minimal required fields', () => {
      const checkpoint: Checkpoint = {
        ...
        cursor: {
          path: ['epic-01'],
          breadcrumbs: [
            { id: 'epic-01', type: 'epic', filePath: '.harness/epic-01.ts', depth: 0 }
          ],
          depth: 0,
        },
        context: {
    ...
    it('should store cursor with path and breadcrumbs', () => {
      const cursor: Cursor = {
        ...
        breadcrumbs: [
          { id: 'epic-01', type: 'epic', filePath: '.harness/epic-01.ts', depth: 0 },
          { id: 'task-003', type: 'task', filePath: '.harness/task-003.ts', depth: 1 },
          { id: 'subtask-002', type: 'subtask', filePath: '.harness/subtask-002.ts', depth: 2 },
        ],
        depth: 2,
      };
    ...
    it('should store execution context', () => {
      const context: ExecutionContext = {
        ...
        rootPath: '.harness/epics/01-epic/epic.ts',
      };
  ...
  describe('Resume Information', () => {
    it('should have all info needed for natural resume', () => {
      ...
      expect(rootPath).toBe('.harness/epic-01.ts');
    });
    ...
    it('should have file paths for navigation', () => {
      const checkpoint: Checkpoint = {
        ...
        cursor: {
          ...
          breadcrumbs: [
            { id: 'epic-01', type: 'epic', filePath: '.harness/epics/01/epic.ts', depth: 0 },
            { id: 'task-003', type: 'task', filePath: '.harness/epics/01/task-003/TASK.md', depth: 1 },
          ],
          depth: 1,
        },
        context: {
          iteration: 1,
          completedUnits: [],
          rootPath: '.harness/epics/01/epic.ts',
        },
      };
    ...
    it('should handle cursor at root (depth 0)', () => {
      const checkpoint: Checkpoint = {
        ...
        cursor: {
          path: ['root'],
          breadcrumbs: [
            { id: 'root', type: 'epic', filePath: '.harness/root.ts', depth: 0 }
          ],
          depth: 0,
        },
        context: {
    ...
    it('should handle many completed units', () => {
      ...
      const checkpoint: Checkpoint = {
        ...
        cursor: {
          ...
          breadcrumbs: [
            { id: 'epic-01', type: 'epic', filePath: '.harness/epic-01.ts', depth: 0 },
            { id: 'task-101', type: 'task', filePath: '.harness/task-101.ts', depth: 1 },
          ],
          depth: 1,
        },
        context: {
