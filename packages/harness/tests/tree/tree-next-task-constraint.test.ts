...
describe('Tree Next Task Constraint - Running Parent Task', () => {
  it('should identify next task in different epic when parent is running', () => {
    ...
    const tree: TaskNode[] = [
      ...
      },
      {
        ...
        filePath: '.harness/epics/02-prepare-designs/002-generate-design-system/TASK.md',
        relPath: '.harness/epics/02-prepare-designs/002-generate-design-system/TASK.md',
  ...
  it('should identify next child task when WBS parent is running', () => {
    ...
    const tree: TaskNode[] = [
      ...
      },
      {
        ...
        filePath: '.harness/epics/01-prepare-designs/003-generate-screens/tasks/003-002-generate-profile-screen/TASK.md',
        relPath: '.harness/epics/01-prepare-designs/003-generate-screens/tasks/003-002-generate-profile-screen/TASK.md',
    ...
    const states: TaskStates = {
      ...
      wbsProgress: new Map([
        ['003-generate-screens', {
          ...
          completedSubtasks: 0,
          failedSubtasks: 0,
          subtaskIds: ['003-001-generate-home-screen', '003-002-generate-profile-screen'],
        }],
      ]),
      blocked: new Set<string>(),
      blockingFailures: new Set<string>(),
  ...
  it('should skip completed children and find next pending child when parent running', () => {
    ...
    expect(nextTask).toBeDefined();
    expect(nextTask?.journalTaskId).toBe('003-generate-screens/003-002-generate-profile-screen');
  });
