# Harness V2 Testing Guide

## Overview

This document describes the comprehensive test suite for the Harness V2 framework. The test suite validates the gap-driven, goal-centric execution system with NO real AI API calls - all AI functions are mocked.
