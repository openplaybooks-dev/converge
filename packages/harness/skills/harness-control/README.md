...
| Configure project | → **`harness-planning` skill** | | |
| Fix dependency | ✓ | plan.md | - | dependency-chain.md* |
| Create tasks/plan | → **`harness-planning` skill** | | |
...
- playbooks/setup.md - Initialize harness for any project
