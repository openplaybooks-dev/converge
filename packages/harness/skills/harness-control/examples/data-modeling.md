...
- Harness waited for 001 to complete before running 002
...
2. **Harness unlocks task** for retry (up to max attempts)
...
```yaml
# .harness/epics/01-prepare-requirements/tasks/001-analyze-sheets-data/TASK.md
---
...
```yaml
# .harness/epics/01-prepare-requirements/tasks/002-generate-sql-schema/TASK.md
---
...
cat .harness/journal/epics/01-prepare-requirements/tasks/001-analyze-sheets-data/attempts/01/LEARN.md
...
vim .harness/epics/01-prepare-requirements/tasks/001-analyze-sheets-data/TASK.md

# Reset and retry
harness reset 001-analyze-sheets-data
harness run --step 001-analyze-sheets-data
```
...
grep dependencies .harness/epics/01-prepare-requirements/tasks/002-generate-sql-schema/TASK.md

# Should have:
.deps(['001-analyze-sheets-data'])

# Add if missing, then reset
harness reset 002-generate-sql-schema
```
