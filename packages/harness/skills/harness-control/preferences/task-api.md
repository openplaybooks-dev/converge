...
**To create tasks:** Use the **`harness-planning`** skill instead.
...
```
.harness/epics/{epic-id}/tasks/{task-id}/TASK.md
```
...
plan:
  ...
  output: .harness/plan.md
```

---

#### `auto-harness` **[Optional]**
...
```bash
cat .harness/epics/05-add-behavior/001-analyze-data-models/data-models.md
```
...
| `auto-harness` | ⬜ | Auto-correction loop |
