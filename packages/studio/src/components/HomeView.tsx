...
const EXAMPLE_PLAYBOOKS = [
  {
    name: "hello-world",
    description: "Minimal 2-task example to learn the playbook format",
  },
  {
    name: "data-pipeline",
    description:
      "ETL pipeline — extract, transform, load with schema validation",
  },
  {
    name: "conceptual-design",
    description: "Generate interactive HTML design concepts from a brief",
  },
  {
    name: "deep-research",
    description: "Multi-phase literature review and synthesis",
  },
  {
    name: "fullstack-app",
    description: "Scaffold and build a full-stack web application",
  },
  {
    name: "flutter-app",
    description: "Generate a cross-platform Flutter mobile app",
  },
];
...
export function HomeView({
  ...
  async function scaffoldExampleIntoWorkspace(
    example: string,
    ws: Workspace,
    overwrite = false,
  ) {
    ...
    <div className="home-view">
      <div className="home-hero">
        ...
        <p className="home-hero__subtitle">
          Long-running AI agents that adapt until{" "}
          <em
            style={{
        ...
        >
          ...
          <div>
            ...
            <span className="home-action-card__desc">
              Describe your goal and let the planner scaffold a task DAG
            </span>
          </div>
        </button>
        <button
          ...
          onClick={onViewAllPlaybooks}
        >
          <Compass size={20} />
          <div>
            <span className="home-action-card__title">Explore examples</span>
            <span className="home-action-card__desc">
              Browse community playbooks for data pipelines, apps, research
            </span>
          </div>
        </button>
      </div>
        ...
        <section className="home-recent">
          ...
          <div className="home-examples__grid">
            {recent.map((pb) => {
              const description =
                pb.description ||
                `${pb.taskCount} task${pb.taskCount === 1 ? "" : "s"}`;
