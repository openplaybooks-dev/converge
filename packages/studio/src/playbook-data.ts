  ...
  groups: [
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          children: [
            {
              id: '02/palette', title: '02/palette', mode: 'spawner', status: 'ok', duration: '00:34',
              summary: 'Extract the body + status + accent palettes from brand.json into CSS custom properties.',
              outputs: ['./tokens/palette.css'], checks: [{ cmd: 'grep -c "cv-bg" ./tokens/palette.css', exit: 0, label: 'body palette present' }], review: null,
              children: [
                {
                  id: '02/palette/body', title: '02/palette/body', mode: 'spawner', status: 'ok', duration: '00:12',
                  summary: 'Body palette — bg, bg-elev, bg-code, text, text-muted, text-dim, border tokens.',
