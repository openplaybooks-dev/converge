...
| 3 | **Beam Execution** | Explore each beam in parallel (dynamic WBS, per-beam tasks) |
| 4 | **Beam Scoring** | Score each beam on 5 dimensions (dynamic WBS, per-beam tasks) |
...
│   │           ├── wbs/wbs.js                   # 6-phase pipeline spawner
│   │           └── tasks/
│   │               ├── frontier-analysis/TASK.md
│   │               ├── beam-spawning/TASK.md
│   │               ├── beam-execution/
│   │               │   ├── TASK.md              # WBS parent
│   │               │   └── wbs/wbs.js           # per-beam spawner
│   │               ├── beam-scoring/
│   │               │   ├── TASK.md              # WBS parent
│   │               │   └── wbs/wbs.js           # per-beam scorer
