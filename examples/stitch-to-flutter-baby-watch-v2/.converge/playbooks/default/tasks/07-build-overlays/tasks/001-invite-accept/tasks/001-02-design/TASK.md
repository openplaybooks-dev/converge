---
id: 001-02-design
title: "Design: Invite Accept"
description: Generate constrained HTML design for Invite Accept overlay using Flutter HTML Glossary
dependencies:
  - 001-01-spec
tags:
  - design
...
checks:
  - id: design-exists
    ...
    cmd: test -f .stitch/designs/invite-accept/design.html
  - id: meta-exists
    description: META.md exists for invite-accept
    cmd: test -f .stitch/designs/invite-accept/META.md
  - id: uses-glossary
    description: HTML uses Flutter HTML Glossary vocabulary
    cmd: "grep -qE 'class=\"(column|row|card|bottom-sheet|dialog)\"' .stitch/designs/invite-accept/design.html"
vars:
...
# Design: Invite Accept

Generate the HTML design mockup for the **Invite Accept** overlay using the **Flutter HTML Glossary** constrained vocabulary.
...
5. **Generate META.md** — Write `.stitch/designs/invite-accept/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/invite-accept/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/invite-accept/META.md` — Example selection and scoring
- `.stitch/designs/invite-accept/design.html` — Self-contained HTML mockup using glossary vocabulary
