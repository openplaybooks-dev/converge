---
id: 003-01-spec
title: "Spec: Timeout Picker"
description: Generate Timeout Picker overlay specification
tags:
  - spec
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/timeout-picker/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >30 lines"
    cmd: test $(wc -l < .stitch/designs/timeout-picker/SPEC.md) -gt 30
plan:
vars:
...
Generate the overlay specification for **Timeout Picker** (`timeout-picker`).
...
Read inputs and produce `.stitch/designs/timeout-picker/SPEC.md` containing:

1. **Overlay Title** — Timeout Picker
...
- `.stitch/designs/timeout-picker/SPEC.md` exists and has >30 lines
