---
id: 002-02-normalize-to-glossary
title: "Normalize to glossary: Home — Safe"
description: Rewrite the reference HTML for home-safe into the Flutter HTML Glossary vocabulary. Constrained transformation — no creative changes.
dependencies:
  - 002-01-link-reference
tags:
  - normalize
  - glossary
  - screen-home-safe
...
checks:
  - id: design-exists
    ...
    cmd: test -f .stitch/designs/home-safe/design.html
  - id: meta-exists
    description: META.md exists
    cmd: test -f .stitch/designs/home-safe/META.md
  - id: design-uses-glossary
    description: design.html uses Flutter HTML Glossary vocabulary
    cmd: "grep -q 'class=\"scaffold\"' .stitch/designs/home-safe/design.html"
  - id: design-has-data-attrs
    description: "design.html uses data-* attributes for Flutter conversion"
    cmd: "grep -q 'data-color=' .stitch/designs/home-safe/design.html"
  - id: meta-names-source
    description: META.md names the normalization source
    cmd: "grep -qE 'Normalized from: `?\\.stitch/designs/home-safe/code\\.html`?' .stitch/designs/home-safe/META.md"
vars:
...
# Normalize to glossary: Home — Safe

Rewrite the reference HTML at `.stitch/designs/home-safe/code.html` into the constrained Flutter HTML Glossary vocabulary at `.stitch/designs/home-safe/design.html`. This is a **mechanical transformation**, not creative generation.

## Inputs

- `.stitch/designs/home-safe/code.html` — the reference HTML (Tailwind + raw HTML, pixel-truth)
...
Emit `.stitch/designs/home-safe/META.md`:
...
- Leaving Tailwind utility classes in `.stitch/designs/home-safe/design.html` — everything must be glossary classes + `data-*`.

## Success Criteria

- `.stitch/designs/home-safe/design.html` exists, uses `class="scaffold"` wrapper
- Uses `data-color="..."` attributes (not hex)
- `.stitch/designs/home-safe/META.md` exists, cites the source
