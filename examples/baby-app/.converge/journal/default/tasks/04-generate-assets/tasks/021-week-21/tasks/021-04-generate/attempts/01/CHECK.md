# Checks: 04-generate-assets/021-week-21/021-04-generate
...
**Command**: `stat -f%z assets/illustrations/baby-sizes/week-21.svg 2>/dev/null | awk '{if ($1 > 100 && $1 < 500000) exit 0; exit 1}'`