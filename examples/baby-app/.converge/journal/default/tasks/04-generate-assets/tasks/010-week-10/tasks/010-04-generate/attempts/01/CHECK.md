# Checks: 04-generate-assets/010-week-10/010-04-generate
...
**Command**: `stat -f%z assets/illustrations/baby-sizes/week-10.svg 2>/dev/null | awk '{if ($1 > 100 && $1 < 500000) exit 0; exit 1}'`