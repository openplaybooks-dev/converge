...
**Output**:
```
Command failed: test -f .stitch/designs/exercise-detail/design.html
```
...
**Output**:
```
Command failed: test -f .stitch/designs/exercise-detail/META.md
```
...
**Output**:
```
grep: .stitch/designs/exercise-detail/design.html: No such file or directory
```
