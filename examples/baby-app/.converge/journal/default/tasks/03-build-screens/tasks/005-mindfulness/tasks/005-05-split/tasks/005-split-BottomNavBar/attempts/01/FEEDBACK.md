...
**Output**:
```
Command failed: test -f lib/screens/mindfulness/widgets/bottom_nav_bar.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/mindfulness/widgets/bottom_nav_bar.dart
