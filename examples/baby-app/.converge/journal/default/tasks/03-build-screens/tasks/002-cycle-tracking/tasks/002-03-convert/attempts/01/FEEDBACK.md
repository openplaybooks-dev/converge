...
**Output**:
```
Command failed: test -f lib/screens/cycle_tracking/cycle_tracking_screen.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/cycle_tracking/cycle_tracking_screen.dart
...
**Output**:
```
grep: lib/screens/cycle_tracking/cycle_tracking_screen.dart: No such file or directory
```
