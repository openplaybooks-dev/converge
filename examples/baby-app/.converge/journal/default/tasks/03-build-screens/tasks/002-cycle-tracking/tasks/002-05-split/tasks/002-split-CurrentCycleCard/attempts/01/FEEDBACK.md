...
**Output**:
```
Command failed: test -f lib/screens/cycle_tracking/widgets/current_cycle_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/cycle_tracking/widgets/current_cycle_card.dart
