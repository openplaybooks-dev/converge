...
**Output**:
```
Command failed: test -f .stitch/designs/health-log/design.html
```
...
**Output**:
```
Command failed: test -f .stitch/designs/health-log/META.md
```
...
**Output**:
```
grep: .stitch/designs/health-log/design.html: No such file or directory
```
