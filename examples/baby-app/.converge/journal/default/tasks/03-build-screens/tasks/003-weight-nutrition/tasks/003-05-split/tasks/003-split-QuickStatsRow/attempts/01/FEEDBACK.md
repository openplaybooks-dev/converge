...
**Output**:
```
Command failed: test -f lib/screens/weight_nutrition/widgets/quick_stats_row.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/weight_nutrition/widgets/quick_stats_row.dart
