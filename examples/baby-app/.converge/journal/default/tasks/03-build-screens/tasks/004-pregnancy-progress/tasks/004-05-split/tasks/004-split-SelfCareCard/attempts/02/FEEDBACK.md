...
**Output**:
```
Command failed: test -f lib/screens/pregnancy_progress/widgets/self_care_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/pregnancy_progress/widgets/self_care_card.dart
