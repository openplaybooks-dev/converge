...
**Output**:
```
Command failed: test -f lib/screens/weight_nutrition/widgets/weight_chart_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/weight_nutrition/widgets/weight_chart_card.dart
