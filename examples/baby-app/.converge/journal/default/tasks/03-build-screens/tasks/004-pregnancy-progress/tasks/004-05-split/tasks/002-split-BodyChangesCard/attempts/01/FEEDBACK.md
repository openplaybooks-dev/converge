...
**Output**:
```
Command failed: test -f lib/screens/pregnancy_progress/widgets/body_changes_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/pregnancy_progress/widgets/body_changes_card.dart
