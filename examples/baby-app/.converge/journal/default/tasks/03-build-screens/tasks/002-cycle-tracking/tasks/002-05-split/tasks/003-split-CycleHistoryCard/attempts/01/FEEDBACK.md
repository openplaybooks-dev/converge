...
**Output**:
```
Command failed: test -f lib/screens/cycle_tracking/widgets/cycle_history_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/cycle_tracking/widgets/cycle_history_card.dart
