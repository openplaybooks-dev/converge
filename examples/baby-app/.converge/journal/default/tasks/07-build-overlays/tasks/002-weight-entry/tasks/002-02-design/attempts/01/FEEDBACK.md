...
**Output**:
```
Command failed: test -f .stitch/designs/weight-entry/design.html
```
...
**Output**:
```
Command failed: test -f .stitch/designs/weight-entry/META.md
```
...
**Output**:
```
grep: .stitch/designs/weight-entry/design.html: No such file or directory
```
