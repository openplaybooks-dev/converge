...
**Output**:
```
Command failed: test -f .stitch/designs/cycle-entry/design.html
```
...
**Output**:
```
Command failed: test -f .stitch/designs/cycle-entry/META.md
```
...
**Output**:
```
grep: .stitch/designs/cycle-entry/design.html: No such file or directory
```
