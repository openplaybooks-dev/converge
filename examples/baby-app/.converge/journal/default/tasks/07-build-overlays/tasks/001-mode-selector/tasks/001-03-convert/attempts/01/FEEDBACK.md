...
**Output**:
```
Command failed: test -f lib/widgets/overlays/mode_selector/mode_selector.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/widgets/overlays/mode_selector/mode_selector.dart
...
**Output**:
```
grep: lib/widgets/overlays/mode_selector/mode_selector.dart: No such file or directory
```
