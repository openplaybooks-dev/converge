...
**Output**:
```
Command failed: test -f .stitch/designs/health-log-entry/design.html
```
...
**Output**:
```
Command failed: test -f .stitch/designs/health-log-entry/META.md
```
...
**Output**:
```
grep: .stitch/designs/health-log-entry/design.html: No such file or directory
```
