# Checks: 07-build-overlays/007-delete-entry/007-03-convert
...
**Command**: `! grep -qE 'Color\(0x|Colors\.' lib/widgets/overlays/delete_entry/delete_entry.dart`

## no-router-registration
**Description**: Overlay does NOT register a GoRoute
**Command**: `! grep -q 'GoRoute' lib/widgets/overlays/delete_entry/delete_entry.dart`