...
5. **Generate META.md** — Write `.stitch/designs/settings/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/settings/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/settings/META.md` — Example selection and scoring
- `.stitch/designs/settings/design.html` — Self-contained HTML mockup at 375px using glossary vocabulary
