...
id: 001-04-analyze
title: "Analyze: Home"
description: Identify extractable widget regions in Home
dependencies:
  - 001-03-convert
tags:
  - analyze
...
checks:
  - id: widgets-json-exists
    description: widgets.jsonl exists for home
    cmd: test -f .stitch/designs/home/widgets.jsonl
plan:
vars:
  prefix: 001
  screenId: home
...
## Input
- `lib/screens/home/home_screen.dart` — The screen widget file

## Task

Read the screen file and identify widget subtrees that should be extracted into separate widget files.

Write `.stitch/designs/home/widgets.jsonl` with one JSON object per line (JSONL format):
...
- `.stitch/designs/home/widgets.jsonl` exists with valid JSONL
