...
checks:
  - id: widget-exists
    ...
    cmd: test -f lib/screens/mindfulness/widgets/bottom_nav_bar.dart
  - id: dart-valid
    description: Dart analysis passes
    cmd: dart analyze lib/screens/mindfulness/widgets/bottom_nav_bar.dart
vars:
  name: BottomNavBar
  grep: _buildBottomNav
  description: "Bottom navigation bar with Home, Progress, Health, Wellness, and Learn tabs"
  shared: true
  widgetName: BottomNavBar
  grepString: _buildBottomNav
  widgetPath: lib/screens/mindfulness/widgets/bottom_nav_bar.dart
