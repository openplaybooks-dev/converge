---
id: 001-05-mount
title: "Mount: Mode Selection"
description: Mount Mode Selection overlay in parent screen and wire trigger
dependencies:
  - 001-04-connect
tags:
  - mount
...
checks:
  - id: parent-imports-overlay
    ...
    cmd: "grep -q 'mode_selector' lib/screens/home/home_screen.dart"
...
Mount the **Mode Selection** overlay in its parent screen (**home**) and wire the trigger.

## Inputs
- `lib/widgets/overlays/mode_selector/mode_selector.dart` — The overlay widget file
- `.stitch/designs/mode-selector/SPEC.md` — Overlay specification (describes trigger and dismiss behavior)
- `lib/screens/home/home_screen.dart` — The parent screen file to modify
...
3. **Add import** — Add the overlay widget import to the parent screen (use the project's package name from `pubspec.yaml`):
   ```dart
   import 'package:<pkg>/widgets/overlays/mode_selector/mode_selector.dart';
   ```
...
5. **Verify** — Run `dart analyze lib/screens/home/home_screen.dart`
...
- `lib/screens/home/home_screen.dart` updated with overlay import
