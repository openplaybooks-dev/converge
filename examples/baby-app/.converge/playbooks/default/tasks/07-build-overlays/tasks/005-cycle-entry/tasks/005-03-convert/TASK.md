---
id: 005-03-convert
title: "Convert: Cycle Entry"
description: Convert constrained HTML design to Flutter widget for Cycle Entry overlay
dependencies:
  - 005-02-design
tags:
  - convert
...
checks:
  - id: widget-exists
    ...
    cmd: test -f lib/widgets/overlays/cycle_entry/cycle_entry.dart
  - id: dart-valid
    description: Dart analysis passes
    cmd: dart analyze lib/widgets/overlays/cycle_entry/cycle_entry.dart
  - id: uses-theme
    description: Uses Theme.of(context) for styling
    cmd: "grep -q 'Theme.of(context)' lib/widgets/overlays/cycle_entry/cycle_entry.dart"
  - id: no-hardcoded-colors
    description: No hardcoded colors — uses colorScheme
    cmd: "! grep -qE 'Color\\(0x|Colors\\.' lib/widgets/overlays/cycle_entry/cycle_entry.dart"
  - id: no-router-registration
    description: Overlay does NOT register a GoRoute
    cmd: "! grep -q 'GoRoute' lib/widgets/overlays/cycle_entry/cycle_entry.dart"
vars:
...
## Inputs
- `.stitch/designs/cycle-entry/design.html` — HTML design mockup (written in Flutter HTML Glossary vocabulary)
...
1. **Read HTML** — Parse `.stitch/designs/cycle-entry/design.html` and extract:
...
3. **Generate Dart** — Write `lib/widgets/overlays/cycle_entry/cycle_entry.dart`:
   ```dart
   import 'package:flutter/material.dart';
   // Use the project's actual package name from pubspec.yaml
   import 'package:<pkg>/theme/app_theme.dart';

   class CycleEntry extends StatelessWidget {
...
5. **Verify** — Run `dart analyze lib/widgets/overlays/cycle_entry/cycle_entry.dart`
...
- `lib/widgets/overlays/cycle_entry/cycle_entry.dart` exists with valid Dart
