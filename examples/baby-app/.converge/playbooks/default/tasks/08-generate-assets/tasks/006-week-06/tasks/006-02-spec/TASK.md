...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/006-week-06/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/006-week-06/SPEC.md
vars:
...
```markdown
# Asset Specification: week-06

## Overview
Baby size comparison illustration showing a sweet pea alongside a gestational sac/fetus at week 6.
