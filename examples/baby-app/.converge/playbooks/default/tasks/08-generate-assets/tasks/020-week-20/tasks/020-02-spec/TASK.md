...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/020-week-20/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/020-week-20/SPEC.md
vars:
...
```markdown
# Asset Specification: week-20

## Overview
Baby size comparison illustration showing a banana alongside a gestational sac/fetus at week 20.
