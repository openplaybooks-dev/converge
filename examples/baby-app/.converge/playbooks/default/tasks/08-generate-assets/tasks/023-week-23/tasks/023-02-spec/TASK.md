...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/023-week-23/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/023-week-23/SPEC.md
vars:
...
```markdown
# Asset Specification: week-23

## Overview
Baby size comparison illustration showing a grapefruit alongside a gestational sac/fetus at week 23.
