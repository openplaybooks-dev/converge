---
id: 016-01-analyze
title: "Analyze — baby-size: Week 16"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/016-week-16/requirements.json
vars:
...
**Baby Size Illustration — Week 16**
- Size comparison: "avocado" 🥑
- Trimester: 2
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
