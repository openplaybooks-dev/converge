...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/001-week-01/SPEC.md
outputs:
  - assets/illustrations/baby-sizes/week-01.svg.meta.json
checks:
  - id: meta-exists
    description: Metadata JSON file exists
    cmd: test -f assets/illustrations/baby-sizes/week-01.svg.meta.json
vars:
...
Create `assets/illustrations/baby-sizes/week-01.svg.meta.json`:
...
```json
{
  ...
  "fileName": "week-01.svg",
  "semantic": {
    "title": "Week 1 Baby Size",
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-1", "poppy seed"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/08-generate-assets/tasks/001-week-01/SPEC.md"
  }
}
```
