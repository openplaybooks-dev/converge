...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/034-week-34/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/034-week-34/SPEC.md
vars:
...
```markdown
# Asset Specification: week-34

## Overview
Baby size comparison illustration showing a cantaloupe alongside a gestational sac/fetus at week 34.
