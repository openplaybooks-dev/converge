---
id: 007-01-analyze
title: "Analyze — baby-size: Week 7"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/007-week-07/requirements.json
vars:
