...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/037-week-37/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/037-week-37/SPEC.md
vars:
...
```markdown
# Asset Specification: week-37

## Overview
Baby size comparison illustration showing a swiss chard alongside a gestational sac/fetus at week 37.
