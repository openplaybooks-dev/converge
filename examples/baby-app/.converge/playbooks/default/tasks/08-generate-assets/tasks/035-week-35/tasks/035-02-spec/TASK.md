...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/035-week-35/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/035-week-35/SPEC.md
vars:
...
```markdown
# Asset Specification: week-35

## Overview
Baby size comparison illustration showing a honeydew alongside a gestational sac/fetus at week 35.
