---
id: 003-01-analyze
title: "Analyze — baby-size: Week 3"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/003-week-03/requirements.json
vars:
