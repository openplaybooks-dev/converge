...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/025-week-25/requirements.json
outputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/025-week-25/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/025-week-25/SPEC.md
vars:
...
```markdown
# Asset Specification: week-25

## Overview
Baby size comparison illustration showing a rutabaga alongside a gestational sac/fetus at week 25.
