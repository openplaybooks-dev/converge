...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/030-week-30/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/030-week-30/SPEC.md
vars:
...
```markdown
# Asset Specification: week-30

## Overview
Baby size comparison illustration showing a cabbage alongside a gestational sac/fetus at week 30.
