...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/038-week-38/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/038-week-38/SPEC.md
vars:
...
```markdown
# Asset Specification: week-38

## Overview
Baby size comparison illustration showing a leek alongside a gestational sac/fetus at week 38.
