...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/026-week-26/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/026-week-26/SPEC.md
vars:
...
```markdown
# Asset Specification: week-26

## Overview
Baby size comparison illustration showing a scallion alongside a gestational sac/fetus at week 26.
