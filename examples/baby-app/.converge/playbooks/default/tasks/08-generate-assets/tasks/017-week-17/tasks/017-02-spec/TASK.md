...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/017-week-17/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/017-week-17/SPEC.md
vars:
...
```markdown
# Asset Specification: week-17

## Overview
Baby size comparison illustration showing a turnip alongside a gestational sac/fetus at week 17.
