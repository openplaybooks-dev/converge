---
id: 033-01-analyze
title: "Analyze — baby-size: Week 33"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/033-week-33/requirements.json
vars:
...
**Baby Size Illustration — Week 33**
- Size comparison: "pineapple" 🍍
- Trimester: 3
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
