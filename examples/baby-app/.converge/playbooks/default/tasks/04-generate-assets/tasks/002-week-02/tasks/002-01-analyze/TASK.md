---
id: 002-01-analyze
title: "Analyze — baby-size: Week 2"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/002-week-02/requirements.json
vars:
