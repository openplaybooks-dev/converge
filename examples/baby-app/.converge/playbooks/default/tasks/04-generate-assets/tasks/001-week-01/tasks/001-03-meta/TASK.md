...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/001-week-01/SPEC.md
outputs:
...
```json
{
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/001-week-01/SPEC.md"
  }
}
```
