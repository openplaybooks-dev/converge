...
Create `assets/illustrations/baby-sizes/week-31.svg.meta.json`:
...
```json
{
  ...
  "semantic": {
    ...
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-31", "coconut"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/031-week-31/SPEC.md"
  }
}
```
