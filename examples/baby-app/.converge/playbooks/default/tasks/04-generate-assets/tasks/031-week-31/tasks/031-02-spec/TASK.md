...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/031-week-31/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/031-week-31/SPEC.md
vars:
...
```markdown
# Asset Specification: week-31

## Overview
Baby size comparison illustration showing a coconut alongside a gestational sac/fetus at week 31.
