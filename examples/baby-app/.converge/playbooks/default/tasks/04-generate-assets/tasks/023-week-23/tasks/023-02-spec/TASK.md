...
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/023-week-23/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/023-week-23/SPEC.md
vars:
