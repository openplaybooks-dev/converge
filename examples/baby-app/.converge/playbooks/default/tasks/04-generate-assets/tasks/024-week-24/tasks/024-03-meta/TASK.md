...
checks:
  - id: meta-exists
    ...
    cmd: test -f assets/illustrations/baby-sizes/week-24.svg.meta.json
vars:
...
Create `assets/illustrations/baby-sizes/week-24.svg.meta.json`:
...
```json
{
  ...
  "fileName": "week-24.svg",
  "semantic": {
    "title": "Week 24 Baby Size",
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-24", "corn"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/024-week-24/SPEC.md"
  }
}
```
