---
id: 032-01-analyze
title: "Analyze — baby-size: Week 32"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/032-week-32/requirements.json
vars:
...
**Baby Size Illustration — Week 32**
- Size comparison: "jicama" 🥔
- Trimester: 3
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
