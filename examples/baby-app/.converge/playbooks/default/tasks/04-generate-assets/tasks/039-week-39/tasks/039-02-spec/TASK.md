...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/039-week-39/requirements.json
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/039-week-39/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/039-week-39/SPEC.md
vars:
...
```markdown
# Asset Specification: week-39

## Overview
Baby size comparison illustration showing a watermelon alongside a gestational sac/fetus at week 39.
