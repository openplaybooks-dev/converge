...
Create `assets/illustrations/baby-sizes/week-27.svg.meta.json`:
...
```json
{
  ...
  "semantic": {
    ...
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-27", "cauliflower"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/027-week-27/SPEC.md"
  }
}
```
