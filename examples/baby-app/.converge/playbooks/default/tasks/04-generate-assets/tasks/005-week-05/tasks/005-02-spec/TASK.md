...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/005-week-05/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/005-week-05/SPEC.md
vars:
...
```markdown
# Asset Specification: week-05

## Overview
Baby size comparison illustration showing a apple seed alongside a gestational sac/fetus at week 5.
