...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/001-week-01/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/001-week-01/SPEC.md
vars:
...
```markdown
# Asset Specification: week-01

## Overview
Baby size comparison illustration showing a poppy seed alongside a gestational sac/fetus at week 1.
