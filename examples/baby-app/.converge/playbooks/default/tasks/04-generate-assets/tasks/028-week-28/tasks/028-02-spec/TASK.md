...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/028-week-28/requirements.json
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/028-week-28/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/028-week-28/SPEC.md
vars:
...
```markdown
# Asset Specification: week-28

## Overview
Baby size comparison illustration showing a eggplant alongside a gestational sac/fetus at week 28.
