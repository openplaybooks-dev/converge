...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/032-week-32/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/032-week-32/SPEC.md
vars:
...
```markdown
# Asset Specification: week-32

## Overview
Baby size comparison illustration showing a jicama alongside a gestational sac/fetus at week 32.
