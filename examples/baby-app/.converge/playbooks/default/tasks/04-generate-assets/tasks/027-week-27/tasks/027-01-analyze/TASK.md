---
id: 027-01-analyze
title: "Analyze — baby-size: Week 27"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/027-week-27/requirements.json
vars:
...
**Baby Size Illustration — Week 27**
- Size comparison: "cauliflower" 🥦
- Trimester: 3
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
