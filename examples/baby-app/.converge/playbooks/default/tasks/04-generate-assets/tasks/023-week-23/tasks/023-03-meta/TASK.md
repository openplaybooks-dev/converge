...
Create `assets/illustrations/baby-sizes/week-23.svg.meta.json`:
...
```json
{
  ...
  "semantic": {
    ...
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-23", "grapefruit"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/023-week-23/SPEC.md"
  }
}
```
