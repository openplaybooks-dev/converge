---
id: 039-01-analyze
title: "Analyze — baby-size: Week 39"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/039-week-39/requirements.json
vars:
...
**Baby Size Illustration — Week 39**
- Size comparison: "watermelon" 🍉
- Trimester: 3
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
