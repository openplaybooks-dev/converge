---
id: 010-01-analyze
title: "Analyze — baby-size: Week 10"
...
inputs:
  ...
  - "lib/screens/**/*.dart"
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/010-week-10/requirements.json
checks:
  - id: requirements-exist
    description: Requirements analysis document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/010-week-10/requirements.json
vars:
...
**Baby Size Illustration — Week 10**
- Size comparison: "prune" 🫐
- Trimester: 1
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
