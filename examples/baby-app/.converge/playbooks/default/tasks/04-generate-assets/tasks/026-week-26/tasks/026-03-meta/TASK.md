...
Create `assets/illustrations/baby-sizes/week-26.svg.meta.json`:
...
```json
{
  ...
  "semantic": {
    ...
    "description": "...",
    "tags": ["baby-size", "pregnancy", "week-26", "scallion"],
    "alt": "..."
  },
  "usage": {
    "screens": ["HomeScreen"],
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/04-generate-assets/tasks/026-week-26/SPEC.md"
  }
}
```
