...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/007-week-07/requirements.json
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/007-week-07/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/007-week-07/SPEC.md
vars:
...
```markdown
# Asset Specification: week-07

## Overview
Baby size comparison illustration showing a blueberry alongside a gestational sac/fetus at week 7.
