---
id: 025-01-analyze
title: "Analyze — baby-size: Week 25"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/025-week-25/requirements.json
vars:
...
**Baby Size Illustration — Week 25**
- Size comparison: "rutabaga" 🥔
- Trimester: 2
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
