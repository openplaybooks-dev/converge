---
id: 013-01-analyze
title: "Analyze — baby-size: Week 13"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/013-week-13/requirements.json
vars:
...
**Baby Size Illustration — Week 13**
- Size comparison: "peach" 🍑
- Trimester: 2
- Used in: HeroIllustrationCard on HomeScreen
- Data source: WeekContent.sizeComparison field
