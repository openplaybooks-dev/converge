...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/024-week-24/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/024-week-24/SPEC.md
vars:
...
## Overview
Baby size comparison illustration showing a corn alongside a gestational sac/fetus at week 24.
