...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/004-week-04/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/004-week-04/SPEC.md
vars:
...
```markdown
# Asset Specification: week-04

## Overview
Baby size comparison illustration showing a poppy seed alongside a gestational sac/fetus at week 4.
