...
outputs:
  - .converge/playbooks/default/tasks/04-generate-assets/tasks/055-icon-status-reminder/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/04-generate-assets/tasks/055-icon-status-reminder/SPEC.md
vars:
