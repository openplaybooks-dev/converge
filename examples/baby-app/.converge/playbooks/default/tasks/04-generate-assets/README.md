...
```bash
converge run 04-generate-assets
```
...
converge run 04-generate-assets --filter baby-size

# Icons only (15 icons)
converge run 04-generate-assets --filter icon

# Empty states only (5 states)
converge run 04-generate-assets --filter empty-state
```
