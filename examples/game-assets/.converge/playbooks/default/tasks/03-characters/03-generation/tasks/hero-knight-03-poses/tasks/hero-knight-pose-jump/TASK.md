---
id: hero-knight-pose-jump
title: Generate Sir Aldric jump pose
description: Jump pose for Sir Aldric
tags:
  - character
  - pose
outputs:
  - assets/characters/hero-knight/variants/jump/jump.png
checks:
  - id: pose-exists
    description: Pose image exists
    cmd: test -s assets/characters/hero-knight/variants/jump/jump.png
vars:
  char_id: hero-knight
  ...
  pose_name: jump
  pose_description: Jump pose for Sir Aldric
---

# Generate Sir Aldric jump Pose

Create jump pose variation for Sir Aldric.
...
Create `assets/characters/hero-knight/variants/jump/jump.png`:
- PNG format
