---
id: forest-elf-pose-jump
title: Generate Lirael jump pose
description: Jump pose for Lirael
tags:
  - character
  - pose
outputs:
  - assets/characters/forest-elf/variants/jump/jump.png
checks:
  - id: pose-exists
    description: Pose image exists
    cmd: test -s assets/characters/forest-elf/variants/jump/jump.png
vars:
  char_id: forest-elf
  char_name: Lirael
  ...
  pose_name: jump
  pose_description: Jump pose for Lirael
---

# Generate Lirael jump Pose

Create jump pose variation for Lirael.
...
Create `assets/characters/forest-elf/variants/jump/jump.png`:
- PNG format
