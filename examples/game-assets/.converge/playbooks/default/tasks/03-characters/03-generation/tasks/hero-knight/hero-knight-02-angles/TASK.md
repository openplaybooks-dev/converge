...
outputs:
  ...
  - assets/characters/hero-knight/ref/front.png
  - assets/characters/hero-knight/ref/side.png
  - assets/characters/hero-knight/ref/back.png
checks:
  - id: angles-exist
    description: Angle references exist
    cmd: test -s assets/characters/hero-knight/ref/angles.json
vars:
  char_id: hero-knight
...
Create reference images in `assets/characters/hero-knight/ref/`:
