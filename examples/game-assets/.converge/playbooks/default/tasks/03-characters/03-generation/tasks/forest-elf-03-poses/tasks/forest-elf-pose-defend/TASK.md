---
id: forest-elf-pose-defend
title: Generate Lirael defend pose
description: Defend pose for Lirael
tags:
  - character
  - pose
outputs:
  - assets/characters/forest-elf/variants/defend/defend.png
checks:
  - id: pose-exists
    description: Pose image exists
    cmd: test -s assets/characters/forest-elf/variants/defend/defend.png
vars:
  char_id: forest-elf
  char_name: Lirael
  ...
  pose_name: defend
  pose_description: Defend pose for Lirael
---

# Generate Lirael defend Pose

Create defend pose variation for Lirael.
...
Create `assets/characters/forest-elf/variants/defend/defend.png`:
- PNG format
