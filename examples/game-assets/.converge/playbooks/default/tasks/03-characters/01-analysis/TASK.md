...
description: Analyze characters and generate design documents from art style
dependencies:
  - "02-asset-breakdown"
outputs:
...
checks:
  - id: analysis-exists
    cmd: test -s .converge/character-analysis.json
    description: Character analysis generated
tags:
  - analysis
  - design
---
