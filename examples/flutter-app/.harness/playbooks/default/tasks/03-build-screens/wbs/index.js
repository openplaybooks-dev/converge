...
export async function run(ctx) {
  ...
  const templateBase = '.harness/playbooks/default/tasks/03-build-screens/wbs/templates/screen';
  ...
  for (let idx = 0; idx < screens.length; idx++) {
    ...
    const basePath = `.harness/playbooks/default/tasks/03-build-screens/tasks/${screenTaskId}`;
