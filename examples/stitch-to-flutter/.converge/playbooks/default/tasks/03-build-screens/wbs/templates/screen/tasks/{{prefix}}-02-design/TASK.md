...
3. **Consult references** — If `.stitch/references/ANALYSIS.md` exists, check the Screen Inventory for matching reference screens and read their `references/*/code.html` files directly as structural guides for the HTML mockup
4. **Select best example match** — Read `.stitch/system/META.md` and score against examples per `stitch-generate/references/selecting-examples.md`
...
- `{{designPath}}` — Self-contained HTML mockup at 375px using glossary vocabulary
