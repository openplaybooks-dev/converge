...
The image's only job is to show painters what `platform-wood-7w` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `platform`
  footprint:    7×1 concept tiles (image aspect = 7:1)
  primary fill: `#7A6F5A`
...
- Honor the primary fill color #7A6F5A and the project palette. Use
