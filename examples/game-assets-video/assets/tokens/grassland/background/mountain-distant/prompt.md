...
The image's only job is to show painters what `mountain-distant` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `background`
  footprint:    15×6 concept tiles (image aspect = 15:6)
  primary fill: `#7A8FB0`
...
- Honor the primary fill color #7A8FB0 and the project palette. Use
