...
The image's only job is to show painters what `tree-band-far` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `background`
  footprint:    12×3 concept tiles (image aspect = 12:3)
  primary fill: `#92A6B2`
...
- Honor the primary fill color #92A6B2 and the project palette. Use
