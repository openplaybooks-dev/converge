...
The image's only job is to show painters what `bush` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `decoration`
  footprint:    2×1 concept tiles (image aspect = 2:1)
  primary fill: `#44772D`
...
- Honor the primary fill color #44772D and the project palette. Use
