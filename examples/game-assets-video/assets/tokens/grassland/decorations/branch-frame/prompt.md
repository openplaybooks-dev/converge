...
The image's only job is to show painters what `branch-frame` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `decoration`
  footprint:    4×6 concept tiles (image aspect = 4:6)
  primary fill: `#876041`
...
- Honor the primary fill color #876041 and the project palette. Use
