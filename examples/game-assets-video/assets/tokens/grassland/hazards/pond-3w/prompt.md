...
The image's only job is to show painters what `pond-3w` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `hazard`
  footprint:    3×1 concept tiles (image aspect = 3:1)
  primary fill: `#3A6FAA`
...
- Honor the primary fill color #3A6FAA and the project palette. Use
