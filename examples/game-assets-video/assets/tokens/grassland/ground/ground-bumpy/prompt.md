...
The image's only job is to show painters what `ground-bumpy` looks like in
...
TOKEN SPEC:
  ...
  biome:        `grassland`
  category:     `ground`
  footprint:    5×2 concept tiles (image aspect = 5:2)
  primary fill: `#5B3B1C`
...
- Honor the primary fill color #5B3B1C and the project palette. Use
