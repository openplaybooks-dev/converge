# Task Journal: 03-shared-props/spike-trap-spritesheet-trigger
...
```bash
  python -c "from PIL import Image; im=Image.open('assets/objects/spike-trap/spritesheets/trigger/trigger.png'); w,h=im.size; assert w>=512 and h>=256, f'sheet too small: {im.size}'"
  ...
  test -s assets/objects/spike-trap/spritesheets/trigger/trigger.prompt.txt
```