# Checks: 03-shared-props/gold-key-spritesheet-collect
...
**Command**: `python -c "from PIL import Image; im=Image.open('assets/objects/gold-key/spritesheets/collect/collect.png'); w,h=im.size; assert w>=512 and h>=256, f'sheet too small: {im.size}'"
`
...
**Command**: `test -s assets/objects/gold-key/spritesheets/collect/collect.prompt.txt`