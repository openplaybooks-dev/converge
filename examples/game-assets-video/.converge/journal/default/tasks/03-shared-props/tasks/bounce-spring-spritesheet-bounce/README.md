# Task Journal: 03-shared-props/bounce-spring-spritesheet-bounce
...
```bash
  python -c "from PIL import Image; im=Image.open('assets/objects/bounce-spring/spritesheets/bounce/bounce.png'); w,h=im.size; assert w>=512 and h>=256, f'sheet too small: {im.size}'"
  ...
  test -s assets/objects/bounce-spring/spritesheets/bounce/bounce.prompt.txt
```