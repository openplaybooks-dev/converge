...
Outputs land in `assets/objects/health-potion/spritesheets/idle/`:
...
To debug, `cat` the prompt or re-run with a different seed: `python scripts/generate_prop_spritesheet.py health-potion idle --seed N`.