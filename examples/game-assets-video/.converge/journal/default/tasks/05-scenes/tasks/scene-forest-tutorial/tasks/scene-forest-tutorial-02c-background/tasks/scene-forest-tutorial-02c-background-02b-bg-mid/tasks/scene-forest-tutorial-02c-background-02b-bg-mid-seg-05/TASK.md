---
id: scene-forest-tutorial-02c-background-02b-bg-mid-seg-05
title: "Scene `forest-tutorial` — bg-mid segment 05/8"
...
outputs:
  - assets/scenes/forest-tutorial/bg-mid/segments/seg-004.png
checks:
  - id: bg-mid-seg-png-exists
    description: bg-mid segment PNG written
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/segments/seg-004.png
...
vars:
  ...
  prev_input_path: assets/scenes/forest-tutorial/bg-mid/segments/seg-003.png
---

# Scene `forest-tutorial` — bg-mid segment 05/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial mid 4 8 \
