---
id: scene-forest-tutorial-02c-background-02b-bg-mid-seg-03
title: "Scene `forest-tutorial` — bg-mid segment 03/8"
...
checks:
  - id: bg-mid-seg-png-exists
    ...
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/segments/seg-002.png
...
vars:
  ...
  prev_input_path: assets/scenes/forest-tutorial/bg-mid/segments/seg-001.png
---

# Scene `forest-tutorial` — bg-mid segment 03/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial mid 2 8 \
