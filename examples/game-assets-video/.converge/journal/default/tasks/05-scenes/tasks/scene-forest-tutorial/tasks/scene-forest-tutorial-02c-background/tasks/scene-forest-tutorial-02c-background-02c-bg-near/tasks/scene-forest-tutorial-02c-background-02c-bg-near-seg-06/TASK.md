---
id: scene-forest-tutorial-02c-background-02c-bg-near-seg-06
title: "Scene `forest-tutorial` — bg-near segment 06/8"
...
vars:
  ...
  seg_ordinal: 06
  seg_count: 8
  seg_index_padded: 005
  seg_prev_padded: 004
  seg_x_lo_norm: 0.6148
  seg_x_hi_norm: 0.6557
  section_label: optional-ledge-access → key-pickup
  section_kind: platform-up → pickup
  prev_input_path: assets/scenes/forest-tutorial/bg-near/seg-004.png
---

# Scene `forest-tutorial` — bg-near segment 06/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial near 5 8 \
