---
id: "scene-forest-tutorial-02c-background-02b-bg-mid-99-stitch"
title: "Scene `forest-tutorial` — stitch bg-mid segments"
...
checks:
  - id: bg-mid-stitched-png-exists
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/final.png
    description: stitched bg-mid.png exists
  - id: bg-mid-stitched-atlas-exists
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/final.atlas.json
