---
id: "scene-forest-tutorial-02c-background-02b-bg-mid-97-validate"
title: "Scene `forest-tutorial` — validate bg-mid segments (vision judge)"
...
checks:
  - id: bg-mid-critique-written
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/critique/critique.json
...
# Scene `forest-tutorial` — validate bg-mid
...
```bash
python scripts/validate_bg_layer.py forest-tutorial mid
```
