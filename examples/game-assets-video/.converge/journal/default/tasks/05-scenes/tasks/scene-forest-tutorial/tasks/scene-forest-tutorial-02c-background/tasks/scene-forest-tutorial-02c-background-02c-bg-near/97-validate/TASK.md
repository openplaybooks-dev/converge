---
id: "scene-forest-tutorial-02c-background-02c-bg-near-97-validate"
title: "Scene `forest-tutorial` — validate bg-near segments (vision judge)"
...
checks:
  - id: bg-near-critique-written
    cmd: test -s assets/scenes/forest-tutorial/bg-near.critique.json
