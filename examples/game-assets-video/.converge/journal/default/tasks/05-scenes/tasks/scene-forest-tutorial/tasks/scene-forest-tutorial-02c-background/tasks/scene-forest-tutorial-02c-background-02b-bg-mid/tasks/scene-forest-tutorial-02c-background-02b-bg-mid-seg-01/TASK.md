---
id: scene-forest-tutorial-02c-background-02b-bg-mid-seg-01
title: "Scene `forest-tutorial` — bg-mid segment 01/8"
...
checks:
  - id: bg-mid-seg-png-exists
    ...
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/segments/seg-000.png
...
vars:
  ...
  prev_input_path: assets/scenes/forest-tutorial/bg-far/final.png
---
