---
id: scene-forest-tutorial-02c-background-02c-bg-near-seg-07
title: "Scene `forest-tutorial` — bg-near segment 07/8"
...
vars:
  ...
  prev_input_path: assets/scenes/forest-tutorial/bg-near/seg-005.png
---

# Scene `forest-tutorial` — bg-near segment 07/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial near 6 8 \
