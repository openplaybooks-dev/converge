---
id: scene-forest-tutorial-02c-background-02c-bg-near-seg-08
title: "Scene `forest-tutorial` — bg-near segment 08/8"
...
vars:
  ...
  prev_input_path: assets/scenes/forest-tutorial/bg-near/seg-006.png
---

# Scene `forest-tutorial` — bg-near segment 08/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial near 7 8 \
