# Task Journal: 05-scenes/scene-forest-tutorial/scene-forest-tutorial-02c-background/scene-forest-tutorial-02c-background-02b-bg-mid/97-validate
...
```bash
  test -s assets/scenes/forest-tutorial/bg-mid/critique/critique.json
  python -c "
import json
