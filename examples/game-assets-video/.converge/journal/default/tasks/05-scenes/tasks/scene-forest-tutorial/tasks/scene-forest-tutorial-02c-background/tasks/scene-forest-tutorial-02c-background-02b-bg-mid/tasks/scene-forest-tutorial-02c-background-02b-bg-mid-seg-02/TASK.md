---
id: scene-forest-tutorial-02c-background-02b-bg-mid-seg-02
title: "Scene `forest-tutorial` — bg-mid segment 02/8"
...
inputs:
  ...
  - assets/scenes/forest-tutorial/bg-mid/segments/seg-000.png
outputs:
  - assets/scenes/forest-tutorial/bg-mid/segments/seg-001.png
checks:
  - id: bg-mid-seg-png-exists
    description: bg-mid segment PNG written
    cmd: test -s assets/scenes/forest-tutorial/bg-mid/segments/seg-001.png
...
vars:
  ...
  seg_ordinal: 02
  seg_count: 8
  seg_index_padded: 001
  seg_prev_padded: 000
  seg_x_lo_norm: 0.1230
  seg_x_hi_norm: 0.2049
  section_label: first-small-rise → health-potion-learn
  section_kind: platform-up → pickup
  prev_input_path: assets/scenes/forest-tutorial/bg-mid/segments/seg-000.png
---

# Scene `forest-tutorial` — bg-mid segment 02/8
...
```bash
python scripts/generate_bg_layer_segment.py forest-tutorial mid 1 8 \
