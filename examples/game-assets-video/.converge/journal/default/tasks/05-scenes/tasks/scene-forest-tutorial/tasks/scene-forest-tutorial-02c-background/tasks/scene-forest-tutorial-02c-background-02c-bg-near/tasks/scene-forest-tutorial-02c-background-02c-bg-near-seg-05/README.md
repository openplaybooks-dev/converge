# Task Journal: 05-scenes/scene-forest-tutorial/scene-forest-tutorial-02c-background/scene-forest-tutorial-02c-background-02c-bg-near/scene-forest-tutorial-02c-background-02c-bg-near-seg-05
...
```bash
  test -s assets/scenes/forest-tutorial/bg-near/seg-004.png
  python -c "
