---
title: Asset Catalog
description: Decompose project intent into a canonical catalog declaring per-prop animation_type, keyframes_id, and tile families.
dependencies:
  - "01b-style-sheet"
outputs:
  - "assets/catalog.json"
checks:
  - id: catalog-exists
    cmd: test -s assets/catalog.json
    description: assets/catalog.json was written
  - id: catalog-props-have-animation-type
    cmd: |
      python -c "
      import json
