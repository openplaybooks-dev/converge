# Screen Specification: Event Delete Confirmation

**Fidelity Source:** Generated from UX.md §3.6 History swipe-to-delete
...
## 2. Purpose
Confirmation dialog when user swipes to delete a history event.
