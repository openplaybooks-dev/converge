...
**Output**:
```
Command failed: test -f lib/screens/settings/widgets/general_settings_section.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/settings/widgets/general_settings_section.dart
