...
**Output**:
```
Command failed: test -f lib/screens/settings/widgets/alert_settings_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/settings/widgets/alert_settings_card.dart
