...
**Outcome**: ❌ FAILED
**Duration**: 5m 8s
**Completed**: 2026-04-21T17:24:13.549Z

## Outputs

- `lib/widgets/guardian_card.dart` — ✓ produced (4.2 KB)
...
### dart-valid — ❌ FAILED
**Command**: `dart analyze lib/widgets/guardian_card.dart`
**Exit code**: 4
**Output**:
```
Analyzing guardian_card.dart...
