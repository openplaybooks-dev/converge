...
**Outcome**: ❌ FAILED
**Duration**: 2m 59s
**Completed**: 2026-04-22T13:25:34.690Z

## Outputs

- `lib/widgets/mute_notifications_row.dart` — ✓ produced (2.3 KB)

## Check Results — ❌ some failed

- ✓ **widget-exists**: Shared widget file exists
- ✗ **dart-valid**: Dart analysis passes

## Failed Check Details

### dart-valid — ❌ FAILED
**Command**: `dart analyze lib/widgets/mute_notifications_row.dart`
**Exit code**: 4
**Output**:
```
Analyzing mute_notifications_row.dart...
