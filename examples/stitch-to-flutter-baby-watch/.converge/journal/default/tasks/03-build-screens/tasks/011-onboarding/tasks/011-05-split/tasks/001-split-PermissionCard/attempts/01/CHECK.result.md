...
**Outcome**: ❌ FAILED
**Duration**: 6m 45s
**Completed**: 2026-04-22T13:33:20.199Z

## Outputs

- `lib/screens/onboarding/widgets/permission_card.dart` — ✓ produced (2.5 KB)
...
### dart-valid — ❌ FAILED
**Command**: `dart analyze lib/screens/onboarding/widgets/permission_card.dart`
**Exit code**: 4
**Output**:
```
