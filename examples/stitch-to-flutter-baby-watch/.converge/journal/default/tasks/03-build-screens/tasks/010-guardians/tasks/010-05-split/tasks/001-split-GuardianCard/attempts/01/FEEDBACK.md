...
**Output**:
```
Command failed: test -f lib/screens/guardians/widgets/guardian_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/guardians/widgets/guardian_card.dart
