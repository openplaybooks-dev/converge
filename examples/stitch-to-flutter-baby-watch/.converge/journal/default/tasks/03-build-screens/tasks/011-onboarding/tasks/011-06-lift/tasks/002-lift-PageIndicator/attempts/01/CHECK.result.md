...
**Outcome**: ❌ FAILED
**Duration**: 8m 12s
**Completed**: 2026-04-22T14:10:30.441Z

## Outputs

- `lib/widgets/page_indicator.dart` — ✓ produced (553 B)
...
### dart-valid — ❌ FAILED
**Command**: `dart analyze lib/widgets/page_indicator.dart`
**Exit code**: 4
**Output**:
```
Analyzing page_indicator.dart...
