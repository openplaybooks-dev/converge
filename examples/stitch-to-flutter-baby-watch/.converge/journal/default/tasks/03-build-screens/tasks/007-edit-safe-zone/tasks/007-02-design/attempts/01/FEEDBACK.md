...
**Output**:
```
Command failed: grep -q 'class="scaffold"' .stitch/designs/edit-safe-zone/design.html
```
...
**Output**:
```
Command failed: grep -q 'data-color=' .stitch/designs/edit-safe-zone/design.html
```
