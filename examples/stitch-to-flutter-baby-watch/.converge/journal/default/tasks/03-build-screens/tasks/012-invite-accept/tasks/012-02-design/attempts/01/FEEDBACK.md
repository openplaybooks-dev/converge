...
**Output**:
```
Command failed: grep -q 'class="scaffold"' .stitch/designs/invite-accept/design.html
```
...
**Output**:
```
Command failed: grep -q 'data-color=' .stitch/designs/invite-accept/design.html
```
