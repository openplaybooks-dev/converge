...
**Output**:
```
Command failed: test -f lib/screens/add_safe_zone/add_safe_zone_screen.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/add_safe_zone/add_safe_zone_screen.dart
...
**Output**:
```
grep: lib/screens/add_safe_zone/add_safe_zone_screen.dart: No such file or directory
```
