...
**Output**:
```
Command failed: grep -q 'class="scaffold"' .stitch/designs/add-safe-zone/design.html
```
...
**Output**:
```
Command failed: grep -q 'data-color=' .stitch/designs/add-safe-zone/design.html
```
