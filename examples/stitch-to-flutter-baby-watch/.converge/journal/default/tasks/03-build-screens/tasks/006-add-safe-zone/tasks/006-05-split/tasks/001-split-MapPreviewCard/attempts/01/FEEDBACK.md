...
**Output**:
```
Command failed: test -f lib/screens/add_safe_zone/widgets/map_preview_card.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/add_safe_zone/widgets/map_preview_card.dart
