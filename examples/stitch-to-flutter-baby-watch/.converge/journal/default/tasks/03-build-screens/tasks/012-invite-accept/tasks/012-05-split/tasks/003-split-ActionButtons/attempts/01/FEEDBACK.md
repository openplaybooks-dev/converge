...
**Output**:
```
Command failed: test -f lib/screens/invite_accept/widgets/action_buttons.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/screens/invite_accept/widgets/action_buttons.dart
