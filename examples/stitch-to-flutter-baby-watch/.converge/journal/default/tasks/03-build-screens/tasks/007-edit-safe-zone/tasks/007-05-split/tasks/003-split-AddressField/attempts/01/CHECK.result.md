...
**Outcome**: ❌ FAILED
**Duration**: 4m 45s
**Completed**: 2026-04-21T14:17:49.749Z

## Outputs

- `lib/screens/edit_safe_zone/widgets/address_field.dart` — ✓ produced (2.1 KB)
...
### dart-valid — ❌ FAILED
**Command**: `dart analyze lib/screens/edit_safe_zone/widgets/address_field.dart`
**Exit code**: 4
**Output**:
```
