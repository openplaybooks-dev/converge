...
**Outcome**: ❌ FAILED
**Duration**: 8m 24s
**Completed**: 2026-04-21T20:47:08.846Z
...
warning - lib/screens/history/history_screen.dart:2:8 - Unused import: 'package:go_router/go_router.dart'. Try removing the import directive. - unused_import
...
warning - lib/screens/timeout_picker/timeout_picker_screen.dart:8:16 - The value of the field '_surfaceContainer' isn't used. Try removing the field, or using it. - unused_field
   ...
   info - lib/screens/history/history_screen.dart:92:13 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:94:22 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:96:19 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:98:19 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:100:19 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:106:13 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:121:13 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
   info - lib/screens/history/history_screen.dart:136:13 - Use 'const' with the constructor to improve performance. Try adding the 'const' keyword to the constructor invocation. - prefer_const_constructors
