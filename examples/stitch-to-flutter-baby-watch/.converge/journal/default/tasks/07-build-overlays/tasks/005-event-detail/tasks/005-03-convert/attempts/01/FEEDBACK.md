...
**Output**:
```
Command failed: test -f lib/widgets/overlays/event_detail/event_detail.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/widgets/overlays/event_detail/event_detail.dart
...
**Output**:
```
grep: lib/widgets/overlays/event_detail/event_detail.dart: No such file or directory
```
