...
**Output**:
```
Command failed: test -f lib/widgets/overlays/alert/alert.dart
```
...
**Output**:
```
Directory or file doesn't exist: lib/widgets/overlays/alert/alert.dart
...
**Output**:
```
grep: lib/widgets/overlays/alert/alert.dart: No such file or directory
```
