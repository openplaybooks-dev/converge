# Task: 06-wire-screens/003-wire-per-screen/001-AlertScreen-ElevatedButton-onPressed-1

Wire the **ElevatedButton** `onPressed` handler in `lib/screens/alert/alert_screen.dart:198`.
