...
**Command**: `node .converge/playbooks/default/tasks/06-wire-screens/003-wire-per-screen/wbs/check-handler.mjs lib/screens/home/home_screen.dart --id HomeScreen-_NavItem-onTap-1 onTap`
**Exit code**: 1
**Output**:
```
FAIL: marker "// @converge:element HomeScreen-_NavItem-onTap-1" not found in lib/screens/home/home_screen.dart
```
