---
id: 052-02-spec
title: "Spec — icon: Weight{{stateName}}"
...
tags:
  ...
  - icon
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/052-icon-status-weight/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/052-icon-status-weight/SPEC.md
vars:
