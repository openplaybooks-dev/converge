---
id: 050-02-spec
title: "Spec — icon: Bookmark{{stateName}}"
...
tags:
  ...
  - icon
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/050-icon-action-bookmark/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/050-icon-action-bookmark/SPEC.md
vars:
