...
Create `week-04.svg.meta.json` in the appropriate assets directory:
...
```json
{
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/08-generate-assets/tasks/004-week-04/SPEC.md"
  }
}
```
