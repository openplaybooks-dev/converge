...
tags:
  ...
  - baby-size
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/015-week-15/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/015-week-15/SPEC.md
vars:
...
Baby size comparison illustration showing a apple alongside 
a gestational sac/fetus at week 15.
