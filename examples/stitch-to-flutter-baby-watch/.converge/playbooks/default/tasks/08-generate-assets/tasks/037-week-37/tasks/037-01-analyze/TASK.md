---
id: 037-01-analyze
title: "Analyze — baby-size: Week 37"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/037-week-37/requirements.json
vars:
...
**Baby Size Illustration — Week 37**
