...
Create `week-02.svg.meta.json` in the appropriate assets directory:
...
```json
{
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/08-generate-assets/tasks/002-week-02/SPEC.md"
  }
}
```
