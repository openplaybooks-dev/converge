...
Create `week-16.svg.meta.json` in the appropriate assets directory:
...
```json
{
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/08-generate-assets/tasks/016-week-16/SPEC.md"
  }
}
```
