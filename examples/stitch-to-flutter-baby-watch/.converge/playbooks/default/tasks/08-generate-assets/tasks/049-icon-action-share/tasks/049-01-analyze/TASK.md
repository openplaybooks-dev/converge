---
id: 049-01-analyze
title: "Analyze — icon: Share{{stateName}}"
...
inputs:
  ...
  - "lib/screens/**/*.dart"
outputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/049-icon-action-share/requirements.json
checks:
  - id: requirements-exist
    description: Requirements analysis document exists
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/049-icon-action-share/requirements.json
vars:
