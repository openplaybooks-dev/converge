...
Create `week-25.svg.meta.json` in the appropriate assets directory:
...
```json
{
  ...
  "source": {
    "spec": ".converge/playbooks/default/tasks/08-generate-assets/tasks/025-week-25/SPEC.md"
  }
}
```
