---
id: 015-01-analyze
title: "Analyze — baby-size: Week 15"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/015-week-15/requirements.json
vars:
...
**Baby Size Illustration — Week 15**
