---
id: 034-01-analyze
title: "Analyze — baby-size: Week 34"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/034-week-34/requirements.json
vars:
...
**Baby Size Illustration — Week 34**
