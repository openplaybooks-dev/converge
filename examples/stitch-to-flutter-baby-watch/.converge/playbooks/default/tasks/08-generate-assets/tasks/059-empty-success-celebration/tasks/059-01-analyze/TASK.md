---
id: 059-01-analyze
title: "Analyze — empty-state: {{iconName}}Success"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/059-empty-success-celebration/requirements.json
vars:
