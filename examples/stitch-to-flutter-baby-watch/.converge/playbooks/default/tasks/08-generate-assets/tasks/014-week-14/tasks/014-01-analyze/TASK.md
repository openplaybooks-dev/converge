---
id: 014-01-analyze
title: "Analyze — baby-size: Week 14"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/014-week-14/requirements.json
vars:
...
**Baby Size Illustration — Week 14**
