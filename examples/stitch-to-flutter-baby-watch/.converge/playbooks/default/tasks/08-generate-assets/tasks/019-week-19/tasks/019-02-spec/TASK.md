...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/019-week-19/SPEC.md
vars:
...
Baby size comparison illustration showing a tomato alongside 
a gestational sac/fetus at week 19.
