---
id: 047-02-spec
title: "Spec — icon: Edit{{stateName}}"
...
outputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/047-icon-action-edit/SPEC.md
checks:
  - id: spec-exists
    description: Visual specification document exists
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/047-icon-action-edit/SPEC.md
vars:
