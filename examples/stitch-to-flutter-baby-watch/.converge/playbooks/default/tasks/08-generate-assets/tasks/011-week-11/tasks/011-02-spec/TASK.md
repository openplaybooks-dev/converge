...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/011-week-11/SPEC.md
vars:
...
Baby size comparison illustration showing a lime alongside 
a gestational sac/fetus at week 11.
