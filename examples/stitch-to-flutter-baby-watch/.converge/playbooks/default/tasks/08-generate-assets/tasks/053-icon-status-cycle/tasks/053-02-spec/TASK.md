---
id: 053-02-spec
title: "Spec — icon: Cycle{{stateName}}"
...
tags:
  ...
  - icon
inputs:
  - .converge/playbooks/default/tasks/08-generate-assets/tasks/053-icon-status-cycle/requirements.json
outputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/053-icon-status-cycle/SPEC.md
vars:
