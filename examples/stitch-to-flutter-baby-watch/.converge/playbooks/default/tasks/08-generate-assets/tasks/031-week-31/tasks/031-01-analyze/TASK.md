---
id: 031-01-analyze
title: "Analyze — baby-size: Week 31"
...
checks:
  - id: requirements-exist
    ...
    cmd: test -f .converge/playbooks/default/tasks/08-generate-assets/tasks/031-week-31/requirements.json
vars:
...
**Baby Size Illustration — Week 31**
