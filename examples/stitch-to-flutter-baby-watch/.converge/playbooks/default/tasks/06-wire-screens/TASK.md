...
Checks use `003-wire-per-screen/wbs/check-handler.mjs` (per-element) and `004-verify/check-all-handlers.mjs` (global) instead of grep to avoid macOS compatibility issues and catch multiline empty handlers.
