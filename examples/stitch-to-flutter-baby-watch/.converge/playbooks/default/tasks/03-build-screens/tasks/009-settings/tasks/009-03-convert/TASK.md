...
description: Convert constrained HTML design to Flutter widgets for Settings using stitch-flutter
dependencies:
  - 009-02-design
tags:
  - convert
...
checks:
  ...
  - id: no-hardcoded-colors
    ...
    cmd: 'test "$(grep -cE "Color\(0x|Colors\." lib/screens/settings/settings_screen.dart)" -eq 0'
vars:
...
## Inputs
- `.stitch/designs/settings/design.html` — HTML design mockup (written in Flutter HTML Glossary vocabulary)
...
1. **Read HTML** — Parse `.stitch/designs/settings/design.html` and extract:
...
3. **Generate Dart** — Write `lib/screens/settings/settings_screen.dart`:
   ```dart
...
- `lib/screens/settings/settings_screen.dart` exists with valid Dart
