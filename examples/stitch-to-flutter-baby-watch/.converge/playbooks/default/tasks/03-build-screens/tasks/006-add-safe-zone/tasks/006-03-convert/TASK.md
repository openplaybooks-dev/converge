---
id: 006-03-convert
title: "Convert: Add Safe Zone"
description: Convert constrained HTML design to Flutter widgets for Add Safe Zone using stitch-flutter
dependencies:
  - 006-02-design
tags:
  - convert
...
checks:
  - id: screen-exists
    ...
    cmd: test -f lib/screens/add_safe_zone/add_safe_zone_screen.dart
  - id: dart-valid
    description: Dart analysis passes
    cmd: dart analyze lib/screens/add_safe_zone/add_safe_zone_screen.dart
  - id: uses-theme
    description: Uses Theme.of(context) for styling
    cmd: "grep -q 'Theme.of(context)' lib/screens/add_safe_zone/add_safe_zone_screen.dart"
  - id: no-hardcoded-colors
    description: No hardcoded colors — uses colorScheme
    cmd: "! grep -qE 'Color\\(0x|Colors\\.' lib/screens/add_safe_zone/add_safe_zone_screen.dart"
vars:
...
# Convert: Add Safe Zone

Convert the constrained HTML design to a pixel-perfect Flutter widget using the **stitch-flutter** skill.

## Inputs
- `.stitch/designs/add-safe-zone/design.html` — HTML design mockup (written in Flutter HTML Glossary vocabulary)
...
1. **Read HTML** — Parse `.stitch/designs/add-safe-zone/design.html` and extract:
...
3. **Generate Dart** — Write `lib/screens/add_safe_zone/add_safe_zone_screen.dart`:
   ```dart
...
5. **Verify** — Run `dart analyze lib/screens/add_safe_zone/add_safe_zone_screen.dart`
...
- `lib/screens/add_safe_zone/add_safe_zone_screen.dart` exists with valid Dart
