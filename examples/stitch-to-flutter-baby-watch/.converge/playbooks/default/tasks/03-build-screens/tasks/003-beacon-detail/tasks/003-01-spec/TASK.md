---
id: 003-01-spec
title: "Spec: Beacon Detail"
description: Generate Beacon Detail screen specification
tags:
  - spec
...
checks:
  - id: spec-exists
    description: SPEC.md exists for beacon-detail
    cmd: test -f .stitch/designs/beacon-detail/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >50 lines"
    cmd: test $(wc -l < .stitch/designs/beacon-detail/SPEC.md) -gt 50
plan:
vars:
...
Generate the screen specification for **Beacon Detail** (`/beacon/:id`).

## Inputs
- `.stitch/system/DESIGN.md` — Design system
- `.stitch/UX.md` — UX overview
- `.stitch/screens.json` — Screen definitions (includes `htmlReference` for this screen: `.stitch/references/chi_ti_t_beacon_phase_2/code.html`)
...
Value from `.stitch/screens.json` for this screen: **`.stitch/references/chi_ti_t_beacon_phase_2/code.html`**
...
Read inputs and produce `.stitch/designs/beacon-detail/SPEC.md` containing:

1. **Screen Title** — Beacon Detail
2. **Purpose** — What this screen does and why
3. **Route** — `/beacon/:id`
4. **Widget Name** — `BeaconDetailScreen`
...
- `.stitch/designs/beacon-detail/SPEC.md` exists and has >50 lines
