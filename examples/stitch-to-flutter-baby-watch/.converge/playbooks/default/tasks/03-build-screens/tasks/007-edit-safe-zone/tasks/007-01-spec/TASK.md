---
id: 007-01-spec
title: "Spec: Edit Safe Zone"
description: Generate Edit Safe Zone screen specification
tags:
  - spec
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/edit-safe-zone/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >50 lines"
    cmd: test $(wc -l < .stitch/designs/edit-safe-zone/SPEC.md) -gt 50
plan:
vars:
