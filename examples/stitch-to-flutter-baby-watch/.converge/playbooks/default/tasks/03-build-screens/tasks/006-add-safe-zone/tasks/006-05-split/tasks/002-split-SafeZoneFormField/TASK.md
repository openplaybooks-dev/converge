...
outputs:
  - lib/screens/add_safe_zone/widgets/safe_zone_form_field.dart
checks:
  - id: widget-exists
    description: Widget file exists
    cmd: test -f lib/screens/add_safe_zone/widgets/safe_zone_form_field.dart
  - id: dart-valid
    description: Dart analysis passes
    cmd: flutter analyze lib/screens/add_safe_zone/widgets/safe_zone_form_field.dart
vars:
  ...
  grepString: "hintText: hint"
  widgetPath: lib/screens/add_safe_zone/widgets/safe_zone_form_field.dart
