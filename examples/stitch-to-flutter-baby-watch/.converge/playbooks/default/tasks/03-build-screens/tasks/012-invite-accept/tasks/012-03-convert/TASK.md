---
id: 012-03-convert
title: "Convert: Accept Invitation"
description: Convert constrained HTML design to Flutter widgets for Accept Invitation using stitch-flutter
dependencies:
  - 012-02-design
tags:
  - convert
...
checks:
  - id: screen-exists
    ...
    cmd: test -f lib/screens/invite_accept/invite_accept_screen.dart
  - id: dart-valid
    description: Dart analysis passes
    cmd: dart analyze lib/screens/invite_accept/invite_accept_screen.dart
  - id: uses-theme
    description: Uses Theme.of(context) for styling
    cmd: "grep -q 'Theme.of(context)' lib/screens/invite_accept/invite_accept_screen.dart"
  - id: no-hardcoded-colors
    description: No hardcoded colors — uses colorScheme
    cmd: grep -qE 'Color\\(0x|Colors\\.' lib/screens/invite_accept/invite_accept_screen.dart && exit 1 || exit 0
vars:
...
3. **Generate Dart** — Write `lib/screens/invite_accept/invite_accept_screen.dart`:
   ```dart
...
5. **Verify** — Run `dart analyze lib/screens/invite_accept/invite_accept_screen.dart`
...
- `lib/screens/invite_accept/invite_accept_screen.dart` exists with valid Dart
