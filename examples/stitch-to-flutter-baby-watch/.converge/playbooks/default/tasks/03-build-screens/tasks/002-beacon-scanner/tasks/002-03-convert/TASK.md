---
id: 002-03-convert
title: "Convert: Beacon Scanner"
description: Convert constrained HTML design to Flutter widgets for Beacon Scanner using stitch-flutter
dependencies:
  - 002-02-design
tags:
  - convert
...
checks:
  - id: screen-exists
    ...
    cmd: test -f lib/screens/beacon_scanner/beacon_scanner_screen.dart
  - id: dart-valid
  ...
  - id: uses-theme
    ...
    cmd: "grep -q 'Theme.of(context)' lib/screens/beacon_scanner/beacon_scanner_screen.dart"
  - id: no-hardcoded-colors
    description: No hardcoded colors — uses colorScheme
    cmd: "! grep -qE 'Color\\(0x|Colors\\.' lib/screens/beacon_scanner/beacon_scanner_screen.dart"
vars:
...
# Convert: Beacon Scanner

Convert the constrained HTML design to a pixel-perfect Flutter widget using the **stitch-flutter** skill.

## Inputs
- `.stitch/designs/beacon-scanner/design.html` — HTML design mockup (written in Flutter HTML Glossary vocabulary)
...
1. **Read HTML** — Parse `.stitch/designs/beacon-scanner/design.html` and extract:
...
3. **Generate Dart** — Write `lib/screens/beacon_scanner/beacon_scanner_screen.dart`:
   ```dart
   ...
   class BeaconScannerScreen extends StatelessWidget {
...
- `lib/screens/beacon_scanner/beacon_scanner_screen.dart` exists with valid Dart
