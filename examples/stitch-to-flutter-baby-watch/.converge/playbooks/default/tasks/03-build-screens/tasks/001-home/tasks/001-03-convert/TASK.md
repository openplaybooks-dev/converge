...
id: 001-03-convert
title: "Convert: Home"
description: Convert constrained HTML design to Flutter widgets for Home using stitch-flutter
dependencies:
  - 001-02-design
tags:
  - convert
...
checks:
  ...
  - id: uses-theme
    ...
    cmd: "grep -q 'Theme.of(context)' lib/screens/home/home_screen.dart"
  - id: no-hardcoded-colors
    description: No hardcoded colors — uses colorScheme
    cmd: "grep -qE 'Color\\(\\[0x|Colors\\.' lib/screens/home/home_screen.dart && exit 1 || exit 0"
vars:
...
## Inputs
- `.stitch/designs/home/design.html` — HTML design mockup (written in Flutter HTML Glossary vocabulary)
...
1. **Read HTML** — Parse `.stitch/designs/home/design.html` and extract:
...
3. **Generate Dart** — Write `lib/screens/home/home_screen.dart`:
   ```dart
...
- `lib/screens/home/home_screen.dart` exists with valid Dart
