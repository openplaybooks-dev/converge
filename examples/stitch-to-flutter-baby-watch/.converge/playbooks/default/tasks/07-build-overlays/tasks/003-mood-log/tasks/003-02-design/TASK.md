---
id: 003-02-design
title: "Design: Mood Logging"
description: Generate constrained HTML design for Mood Logging overlay using Flutter HTML Glossary
dependencies:
  - 003-01-spec
tags:
  - design
...
checks:
  - id: design-exists
    ...
    cmd: test -f .stitch/designs/mood-log/design.html
  - id: meta-exists
    description: META.md exists for mood-log
    cmd: test -f .stitch/designs/mood-log/META.md
  - id: uses-glossary
    description: HTML uses Flutter HTML Glossary vocabulary
    cmd: "grep -qE 'class=\"(column|row|card|bottom-sheet|dialog)\"' .stitch/designs/mood-log/design.html"
vars:
...
Generate the HTML design mockup for the **Mood Logging** overlay using the **Flutter HTML Glossary** constrained vocabulary.
...
1. **Read spec** — Load `.stitch/designs/mood-log/SPEC.md` to understand layout, sections, data
...
5. **Generate META.md** — Write `.stitch/designs/mood-log/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/mood-log/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/mood-log/META.md` — Example selection and scoring
- `.stitch/designs/mood-log/design.html` — Self-contained HTML mockup using glossary vocabulary
