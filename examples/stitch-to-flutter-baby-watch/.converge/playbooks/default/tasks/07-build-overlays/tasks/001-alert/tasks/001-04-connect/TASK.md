---
id: 001-04-connect
title: "Connect: Alert Screen"
description: Wire Riverpod providers and action handlers for Alert Screen overlay
dependencies:
  - 001-03-convert
tags:
  - connect
...
# Connect: Alert Screen

Wire Riverpod providers and action handlers into the **Alert Screen** overlay widget.

## Inputs
- `lib/widgets/overlays/alert/alert.dart` — The overlay widget (from convert step)
- `.stitch/designs/alert/SPEC.md` — Overlay specification (for data requirements)
...
- `lib/widgets/overlays/alert/alert.dart` updated with provider connections
