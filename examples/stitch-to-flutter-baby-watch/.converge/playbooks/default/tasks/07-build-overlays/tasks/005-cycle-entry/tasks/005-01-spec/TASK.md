---
id: 005-01-spec
title: "Spec: Cycle Entry"
description: Generate Cycle Entry overlay specification
tags:
  - spec
  - overlay-cycle-entry
inputs:
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/cycle-entry/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >30 lines"
    cmd: test $(wc -l < .stitch/designs/cycle-entry/SPEC.md) -gt 30
plan:
vars:
