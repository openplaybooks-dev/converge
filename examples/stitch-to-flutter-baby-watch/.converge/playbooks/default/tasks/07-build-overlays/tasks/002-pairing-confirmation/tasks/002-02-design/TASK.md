---
id: 002-02-design
title: "Design: Pairing Confirmation"
description: Generate constrained HTML design for Pairing Confirmation overlay using Flutter HTML Glossary
dependencies:
  - 002-01-spec
tags:
  - design
...
checks:
  - id: design-exists
    ...
    cmd: test -f .stitch/designs/pairing-confirmation/design.html
  - id: meta-exists
    description: META.md exists for pairing-confirmation
    cmd: test -f .stitch/designs/pairing-confirmation/META.md
  - id: uses-glossary
    description: HTML uses Flutter HTML Glossary vocabulary
    cmd: "grep -qE 'class=\"(column|row|card|bottom-sheet|dialog)\"' .stitch/designs/pairing-confirmation/design.html"
vars:
...
# Design: Pairing Confirmation

Generate the HTML design mockup for the **Pairing Confirmation** overlay using the **Flutter HTML Glossary** constrained vocabulary.
...
1. **Read spec** — Load `.stitch/designs/pairing-confirmation/SPEC.md` to understand layout, sections, data
...
5. **Generate META.md** — Write `.stitch/designs/pairing-confirmation/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/pairing-confirmation/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/pairing-confirmation/META.md` — Example selection and scoring
- `.stitch/designs/pairing-confirmation/design.html` — Self-contained HTML mockup using glossary vocabulary
