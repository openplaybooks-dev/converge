---
id: 007-05-mount
title: "Mount: Delete Entry Confirmation"
description: Mount Delete Entry Confirmation overlay in parent screen and wire trigger
dependencies:
  - 007-04-connect
tags:
  - mount
...
checks:
  - id: parent-imports-overlay
    ...
    cmd: "grep -q 'delete_entry' lib/screens/health_log/health_log_screen.dart"
...
# Mount: Delete Entry Confirmation

Mount the **Delete Entry Confirmation** overlay in its parent screen (**health-log**) and wire the trigger.

## Inputs
- `lib/widgets/overlays/delete_entry/delete_entry.dart` — The overlay widget file
- `.stitch/designs/delete-entry/SPEC.md` — Overlay specification (describes trigger and dismiss behavior)
...
3. **Add import** — Add the overlay widget import to the parent screen (use the project's package name from `pubspec.yaml`):
   ```dart
   import 'package:<pkg>/widgets/overlays/delete_entry/delete_entry.dart';
   ```
