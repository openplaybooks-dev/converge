---
id: 002-01-spec
title: "Spec: Pairing Confirmation"
description: Generate Pairing Confirmation overlay specification
tags:
  - spec
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/pairing-confirmation/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >30 lines"
    cmd: test $(wc -l < .stitch/designs/pairing-confirmation/SPEC.md) -gt 30
plan:
vars:
...
# Spec: Pairing Confirmation

Generate the overlay specification for **Pairing Confirmation** (`pairing-confirmation`).
...
Read inputs and produce `.stitch/designs/pairing-confirmation/SPEC.md` containing:

1. **Overlay Title** — Pairing Confirmation
...
6. **Widget Name** — `PairingConfirmation`
...
- `.stitch/designs/pairing-confirmation/SPEC.md` exists and has >30 lines
