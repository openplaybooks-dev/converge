---
id: 007-01-spec
title: "Spec: Delete Entry Confirmation"
description: Generate Delete Entry Confirmation overlay specification
tags:
  - spec
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/delete-entry/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >30 lines"
    cmd: test $(wc -l < .stitch/designs/delete-entry/SPEC.md) -gt 30
plan:
vars:
...
# Spec: Delete Entry Confirmation

Generate the overlay specification for **Delete Entry Confirmation** (`delete-entry`).
...
This is an **overlay** (dialog), not a full screen. It is triggered from the **health-log** screen. Overlays are presented using `showModalBottomSheet()`, `showDialog()`, or persistent bar patterns — never via GoRouter navigation.
...
Read inputs and produce `.stitch/designs/delete-entry/SPEC.md` containing:

1. **Overlay Title** — Delete Entry Confirmation
...
- `.stitch/designs/delete-entry/SPEC.md` exists and has >30 lines
