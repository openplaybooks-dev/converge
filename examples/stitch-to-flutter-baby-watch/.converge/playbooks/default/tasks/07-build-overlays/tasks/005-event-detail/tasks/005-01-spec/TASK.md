---
id: 005-01-spec
title: "Spec: Event Detail"
description: Generate Event Detail overlay specification
tags:
  - spec
...
checks:
  - id: spec-exists
    ...
    cmd: test -f .stitch/designs/event-detail/SPEC.md
  - id: spec-has-content
    description: "SPEC.md has >30 lines"
    cmd: test $(wc -l < .stitch/designs/event-detail/SPEC.md) -gt 30
plan:
vars:
...
Generate the overlay specification for **Event Detail** (`event-detail`).
...
Read inputs and produce `.stitch/designs/event-detail/SPEC.md` containing:

1. **Overlay Title** — Event Detail
...
- `.stitch/designs/event-detail/SPEC.md` exists and has >30 lines
