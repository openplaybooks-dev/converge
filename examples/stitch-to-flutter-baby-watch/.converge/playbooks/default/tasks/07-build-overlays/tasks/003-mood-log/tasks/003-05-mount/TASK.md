---
id: 003-05-mount
title: "Mount: Mood Logging"
description: Mount Mood Logging overlay in parent screen and wire trigger
dependencies:
  - 003-04-connect
tags:
  - mount
...
checks:
  - id: parent-imports-overlay
    ...
    cmd: "grep -q 'mood_log' lib/screens/mood_wellness/mood_wellness_screen.dart"
  - id: parent-shows-overlay
    description: Parent screen calls showModalBottomSheet or showDialog
    cmd: "grep -qE 'showModalBottomSheet|showDialog' lib/screens/mood_wellness/mood_wellness_screen.dart"
  - id: dart-valid
    description: Dart analysis passes for parent screen
    cmd: dart analyze lib/screens/mood_wellness/mood_wellness_screen.dart
vars:
  prefix: 003
  overlayId: mood-log
  title: Mood Logging
...
Mount the **Mood Logging** overlay in its parent screen (**mood-wellness**) and wire the trigger.

## Inputs
- `lib/widgets/overlays/mood_log/mood_log.dart` — The overlay widget file
- `.stitch/designs/mood-log/SPEC.md` — Overlay specification (describes trigger and dismiss behavior)
- `lib/screens/mood_wellness/mood_wellness_screen.dart` — The parent screen file to modify
...
3. **Add import** — Add the overlay widget import to the parent screen (use the project's package name from `pubspec.yaml`):
   ```dart
   import 'package:<pkg>/widgets/overlays/mood_log/mood_log.dart';
   ```
...
- `lib/screens/mood_wellness/mood_wellness_screen.dart` updated with overlay import
