---
id: 006-02-design
title: "Design: Due Date Picker"
description: Generate constrained HTML design for Due Date Picker overlay using Flutter HTML Glossary
dependencies:
  - 006-01-spec
tags:
  - design
...
outputs:
  - .stitch/designs/due-date-picker/META.md
  - .stitch/designs/due-date-picker/design.html
checks:
  - id: design-exists
    description: design.html exists for due-date-picker
    cmd: test -f .stitch/designs/due-date-picker/design.html
  - id: meta-exists
    description: META.md exists for due-date-picker
    cmd: test -f .stitch/designs/due-date-picker/META.md
  - id: uses-glossary
    description: HTML uses Flutter HTML Glossary vocabulary
    cmd: "grep -qE 'class=\"(column|row|card|bottom-sheet|dialog)\"' .stitch/designs/due-date-picker/design.html"
vars:
...
# Design: Due Date Picker

Generate the HTML design mockup for the **Due Date Picker** overlay using the **Flutter HTML Glossary** constrained vocabulary.
...
1. **Read spec** — Load `.stitch/designs/due-date-picker/SPEC.md` to understand layout, sections, data
...
5. **Generate META.md** — Write `.stitch/designs/due-date-picker/META.md` with example selection and scoring table
6. **Generate design.html** — Write `.stitch/designs/due-date-picker/design.html` following `stitch-generate` skill using ONLY glossary elements
...
- `.stitch/designs/due-date-picker/META.md` — Example selection and scoring
- `.stitch/designs/due-date-picker/design.html` — Self-contained HTML mockup using glossary vocabulary
