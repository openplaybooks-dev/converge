...
class SafeZoneDeleteConfirmationScreen extends StatelessWidget {
  const SafeZoneDeleteConfirmationScreen({super.key});
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Vùng này sẽ bị xóa vĩnh viễn và bạn sẽ không nhận được cảnh báo khi ở đây.',
